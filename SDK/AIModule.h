...
{
	EEnvQueryPriority__Normal                                                        = 0,
	EEnvQueryPriority__High                                                          = 1
};
...
public:
	...
	/// Functions
	// Function /Script/AIModule.BTService.SetTickInterval
	// void SetTickInterval(float TickInterval, float TickRandomDeviation);                                                     // [0x5fac9e0] Final|Native|Public|BlueprintCallable 
};
...
/// Size: 0x0090 (144 bytes) (0x000358 - 0x0003E8) align 8 pad: 0x0000
class AAIController : public AController
{ 
public:
	unsigned char                                      UnknownData00_3[0x38];                                      // 0x0358   (0x0038)  MISSED
	bool                                               bStartAILogicOnPossess : 1;                                 // 0x0390:0 (0x0001)  
	bool                                               bStopAILogicOnUnposses : 1;                                 // 0x0390:1 (0x0001)  
	bool                                               bLOSflag : 1;                                               // 0x0390:2 (0x0001)  
	bool                                               bSkipExtraLOSChecks : 1;                                    // 0x0390:3 (0x0001)  
	bool                                               bAllowStrafe : 1;                                           // 0x0390:4 (0x0001)  
	bool                                               bWantsPlayerState : 1;                                      // 0x0390:5 (0x0001)  
	bool                                               bSetControlRotationFromPawnOrientation : 1;                 // 0x0390:6 (0x0001)  
	unsigned char                                      UnknownData01_5[0x7];                                       // 0x0391   (0x0007)  MISSED
	class UPathFollowingComponent*                     PathFollowingComponent;                                     // 0x0398   (0x0008)  
	class UBrainComponent*                             BrainComponent;                                             // 0x03A0   (0x0008)  
	class UAIPerceptionComponent*                      PerceptionComponent;                                        // 0x03A8   (0x0008)  
	class UPawnActionsComponent*                       ActionsComp;                                                // 0x03B0   (0x0008)  
	class UBlackboardComponent*                        Blackboard;                                                 // 0x03B8   (0x0008)  
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                               // 0x03C0   (0x0008)  
	class UClass*                                      DefaultNavigationFilterClass;                               // 0x03C8   (0x0008)  
	SDK_UNDEFINED(16,370) /* FMulticastInlineDelegate */ __um(ReceiveMoveCompleted);                               // 0x03D0   (0x0010)  
	unsigned char                                      UnknownData02_7[0x8];                                       // 0x03E0   (0x0008)  MISSED


	/// Functions
	// Function /Script/AIModule.AIController.UseBlackboard
	// bool UseBlackboard(class UBlackboardData* BlackboardAsset, class UBlackboardComponent*& BlackboardComponent);            // [0x5f9eb30] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIController.UnclaimTaskResource
	// void UnclaimTaskResource(class UClass* ResourceClass);                                                                   // [0x5f9e8e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetPathFollowingComponent
	// void SetPathFollowingComponent(class UPathFollowingComponent* NewPFComponent);                                           // [0x5f9e3d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.SetMoveBlockDetection
	// void SetMoveBlockDetection(bool bEnable);                                                                                // [0x5f9e340] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.RunBehaviorTree
	// bool RunBehaviorTree(class UBehaviorTree* BTAsset);                                                                      // [0x5f9e150] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.OnUsingBlackBoard
	// void OnUsingBlackBoard(class UBlackboardComponent* BlackboardComp, class UBlackboardData* BlackboardAsset);              // [0x3a75280] Event|Protected|BlueprintEvent 
	// Function /Script/AIModule.AIController.OnGameplayTaskResourcesClaimed
	// void OnGameplayTaskResourcesClaimed(FGameplayResourceSet NewlyClaimed, FGameplayResourceSet FreshlyReleased);            // [0x5f9de10] Native|Public        
	// Function /Script/AIModule.AIController.MoveToLocation
	// TEnumAsByte<EPathFollowingRequestResult> MoveToLocation(FVector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x5f9db80] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.MoveToActor
	// TEnumAsByte<EPathFollowingRequestResult> MoveToActor(class AActor* Goal, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bCanStrafe, class UClass* FilterClass, bool bAllowPartialPath); // [0x5f9d940] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocus
	// void K2_SetFocus(class AActor* NewFocus);                                                                                // [0x5f9d7a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_SetFocalPoint
	// void K2_SetFocalPoint(FVector FP);                                                                                       // [0x5f9d710] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIController.K2_ClearFocus
	// void K2_ClearFocus();                                                                                                    // [0x5f9d6f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIController.HasPartialPath
	// bool HasPartialPath();                                                                                                   // [0x5f9d510] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetPathFollowingComponent
	// class UPathFollowingComponent* GetPathFollowingComponent();                                                              // [0x5f9d1e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetMoveStatus
	// TEnumAsByte<EPathFollowingStatus> GetMoveStatus();                                                                       // [0x5f9d120] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetImmediateMoveDestination
	// FVector GetImmediateMoveDestination();                                                                                   // [0x5f9cfc0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocusActor
	// class AActor* GetFocusActor();                                                                                           // [0x5f9cf90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPointOnActor
	// FVector GetFocalPointOnActor(class AActor* Actor);                                                                       // [0x5f9cee0] Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetFocalPoint
	// FVector GetFocalPoint();                                                                                                 // [0x5f9cea0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIController.GetAIPerceptionComponent
	// class UAIPerceptionComponent* GetAIPerceptionComponent();                                                                // [0x5f9c9d0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIController.ClaimTaskResource
	// void ClaimTaskResource(class UClass* ResourceClass);                                                                     // [0x5f9c6b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	TArray<FNavigationLink>                            PointLinks;                                                 // 0x02F0   (0x0010)  
	TArray<FNavigationSegmentLink>                     SegmentLinks;                                               // 0x0300   (0x0010)  
	class UNavLinkCustomComponent*                     SmartLinkComp;                                              // 0x0310   (0x0008)  
	bool                                               bSmartLinkIsRelevant;                                       // 0x0318   (0x0001)  
	unsigned char                                      UnknownData01_6[0x7];                                       // 0x0319   (0x0007)  MISSED
	SDK_UNDEFINED(16,371) /* FMulticastInlineDelegate */ __um(OnSmartLinkReached);                                 // 0x0320   (0x0010)  


	/// Functions
	// Function /Script/AIModule.NavLinkProxy.SetSmartLinkEnabled
	// void SetSmartLinkEnabled(bool bEnabled);                                                                                 // [0x5fb7470] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ResumePathFollowing
	// void ResumePathFollowing(class AActor* Agent);                                                                           // [0x5fb7280] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLinkProxy.ReceiveSmartLinkReached
	// void ReceiveSmartLinkReached(class AActor* Agent, FVector& Destination);                                                 // [0x3a75280] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/AIModule.NavLinkProxy.IsSmartLinkEnabled
	// bool IsSmartLinkEnabled();                                                                                               // [0x5fb6bd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.NavLinkProxy.HasMovingAgents
	// bool HasMovingAgents();                                                                                                  // [0x5fb6ba0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.PathFollowingComponent
/// Size: 0x01A0 (416 bytes) (0x0000F8 - 0x000298) align 8 pad: 0x0000
class UPathFollowingComponent : public UActorComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x38];                                      // 0x00F8   (0x0038)  MISSED
	class UNavMovementComponent*                       MovementComp;                                               // 0x0130   (0x0008)  
	unsigned char                                      UnknownData01_6[0x8];                                       // 0x0138   (0x0008)  MISSED
	class ANavigationData*                             MyNavData;                                                  // 0x0140   (0x0008)  
	unsigned char                                      UnknownData02_7[0x150];                                     // 0x0148   (0x0150)  MISSED


	/// Functions
	// Function /Script/AIModule.PathFollowingComponent.OnNavDataRegistered
	// void OnNavDataRegistered(class ANavigationData* NavData);                                                                // [0x5fb70f0] Final|Native|Protected 
	// Function /Script/AIModule.PathFollowingComponent.OnActorBump
	// void OnActorBump(class AActor* SelfActor, class AActor* OtherActor, FVector NormalImpulse, FHitResult& Hit);             // [0x5fb6f50] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PathFollowingComponent.GetPathDestination
	// FVector GetPathDestination();                                                                                            // [0x5fb6b60] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PathFollowingComponent.GetPathActionType
	// TEnumAsByte<EPathFollowingAction> GetPathActionType();                                                                   // [0x5fb6b30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UObject* GetQuerier();                                                                                             // [0x5faff20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.DoItemGeneration
	// void DoItemGeneration(TArray<FVector>& ContextLocations);                                                                // [0x3a75280] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedVector
	// void AddGeneratedVector(FVector GeneratedVector);                                                                        // [0x5fafe90] Final|Native|Public|HasDefaults|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryGenerator_BlueprintBase.AddGeneratedActor
	// void AddGeneratedActor(class AActor* GeneratedActor);                                                                    // [0x5fafe00] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,372) /* FMulticastInlineDelegate */ __um(OnQueryFinishedEvent);                               // 0x0068   (0x0010)  


	/// Functions
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.SetNamedParam
	// void SetNamedParam(FName ParamName, float Value);                                                                        // [0x5fb3c60] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsLocations
	// TArray<FVector> GetResultsAsLocations();                                                                                 // [0x5fb3a10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetResultsAsActors
	// TArray<AActor*> GetResultsAsActors();                                                                                    // [0x5fb3920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsLocations
	// bool GetQueryResultsAsLocations(TArray<FVector>& ResultLocations);                                                       // [0x5fb3860] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetQueryResultsAsActors
	// bool GetQueryResultsAsActors(TArray<AActor*>& ResultActors);                                                             // [0x5fb3780] Final|Native|Public|HasOutParms|BlueprintCallable|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.GetItemScore
	// float GetItemScore(int32_t ItemIndex);                                                                                   // [0x5fb36e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.EnvQueryInstanceBlueprintWrapper.EQSQueryDoneSignature__DelegateSignature
	// void EQSQueryDoneSignature__DelegateSignature(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, TEnumAsByte<EEnvQueryStatus> QueryStatus); // [0x3a75280] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	// class UEnvQueryInstanceBlueprintWrapper* RunEQSQuery(class UObject* WorldContextObject, class UEnvQuery* QueryTemplate, class UObject* Querier, TEnumAsByte<EEnvQueryRunMode> RunMode, class UClass* WrapperClass, TEnumAsByte<EEnvQueryPriority> QueryPriority); // [0x5fb3a90] Final|Native|Static|Public|BlueprintCallable 
};

/// Class /Script/AIModule.AIPerceptionComponent
/// Size: 0x00E0 (224 bytes) (0x0000F8 - 0x0001D8) align 8 pad: 0x0000
class UAIPerceptionComponent : public UActorComponent
{ 
public:
	TArray<class UAISenseConfig*>                      SensesConfig;                                               // 0x00F8   (0x0010)  
	class UClass*                                      DominantSense;                                              // 0x0108   (0x0008)  
	unsigned char                                      UnknownData00_6[0x10];                                      // 0x0110   (0x0010)  MISSED
	class AAIController*                               AIOwner;                                                    // 0x0120   (0x0008)  
	unsigned char                                      UnknownData01_6[0x80];                                      // 0x0128   (0x0080)  MISSED
	SDK_UNDEFINED(16,373) /* FMulticastInlineDelegate */ __um(OnPerceptionUpdated);                                // 0x01A8   (0x0010)  
	SDK_UNDEFINED(16,374) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionUpdated);                          // 0x01B8   (0x0010)  
	SDK_UNDEFINED(16,375) /* FMulticastInlineDelegate */ __um(OnTargetPerceptionInfoUpdated);                      // 0x01C8   (0x0010)  


	/// Functions
	// Function /Script/AIModule.AIPerceptionComponent.SetSenseEnabled
	// void SetSenseEnabled(class UClass* SenseClass, bool bEnable);                                                            // [0x5f9e460] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.RequestStimuliListenerUpdate
	// void RequestStimuliListenerUpdate();                                                                                     // [0x5f9e130] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.OnOwnerEndPlay
	// void OnOwnerEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                                     // [0x5f9dfb0] Final|Native|Public  
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActorsBySense
	// void GetPerceivedHostileActorsBySense(class UClass* SenseToUse, TArray<AActor*>& OutActors);                             // [0x5f9d3f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedHostileActors
	// void GetPerceivedHostileActors(TArray<AActor*>& OutActors);                                                              // [0x5f9d320] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetPerceivedActors
	// void GetPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                           // [0x5f9d200] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetKnownPerceivedActors
	// void GetKnownPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                      // [0x5f9d000] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetCurrentlyPerceivedActors
	// void GetCurrentlyPerceivedActors(class UClass* SenseToUse, TArray<AActor*>& OutActors);                                  // [0x5f9cd80] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AIPerceptionComponent.GetActorsPerception
	// bool GetActorsPerception(class AActor* Actor, FActorPerceptionBlueprintInfo& Info);                                      // [0x5f9c9f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionComponent.ForgetAll
	// void ForgetAll();                                                                                                        // [0x5f9c920] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ReportPerceptionEvent(class UObject* WorldContextObject, class UAISenseEvent* PerceptionEvent);                     // [0x5fa32c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.ReportEvent
	// void ReportEvent(class UAISenseEvent* PerceptionEvent);                                                                  // [0x5fa3050] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.RegisterPerceptionStimuliSource
	// bool RegisterPerceptionStimuliSource(class UObject* WorldContextObject, class UClass* Sense, class AActor* Target);      // [0x5fa2d60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionSystem.OnPerceptionStimuliSourceEndPlay
	// void OnPerceptionStimuliSourceEndPlay(class AActor* Actor, TEnumAsByte<EEndPlayReason> EndPlayReason);                   // [0x5fa2c90] Final|Native|Protected 
	// Function /Script/AIModule.AIPerceptionSystem.GetSenseClassForStimulus
	// class UClass* GetSenseClassForStimulus(class UObject* WorldContextObject, FAIStimulus& Stimulus);                        // [0x5fa2b60] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	class AActor*                                      NoiseRelator;                                               // 0x0020   (0x0008)  
...
public:
	...
	// void ReportNoiseEvent(class UObject* WorldContextObject, FVector NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, FName Tag); // [0x5fa30e0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x00F0 (240 bytes) (0x000058 - 0x000148) align 8 pad: 0x0000
class UAISystem : public UAISystemBase
{ 
public:
	FSoftClassPath                                     PerceptionSystemClassName;                                  // 0x0058   (0x0018)  
	FSoftClassPath                                     EnvQueryManagerClassName;                                   // 0x0070   (0x0018)  
	FSoftClassPath                                     HotSpotManagerClassName;                                    // 0x0088   (0x0018)  
	...
	bool                                               bEnableBTAITasks;                                           // 0x00AF   (0x0001)  
	bool                                               bAllowControllersAsEQSQuerier;                              // 0x00B0   (0x0001)  
	bool                                               bEnableDebuggerPlugin;                                      // 0x00B1   (0x0001)  
	bool                                               bForgetStaleActors;                                         // 0x00B2   (0x0001)  
	bool                                               bAddBlackboardSelfKey;                                      // 0x00B3   (0x0001)  
	TEnumAsByte<ECollisionChannel>                     DefaultSightCollisionChannel;                               // 0x00B4   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x00B5   (0x0003)  MISSED
	class UBehaviorTreeManager*                        BehaviorTreeManager;                                        // 0x00B8   (0x0008)  
	class UEnvQueryManager*                            EnvironmentQueryManager;                                    // 0x00C0   (0x0008)  
	class UAIPerceptionSystem*                         PerceptionSystem;                                           // 0x00C8   (0x0008)  
	TArray<class UAIAsyncTaskBlueprintProxy*>          AllProxyObjects;                                            // 0x00D0   (0x0010)  
	class UAIHotSpotManager*                           HotSpotManager;                                             // 0x00E0   (0x0008)  
	class UNavLocalGridManager*                        NavLocalGrids;                                              // 0x00E8   (0x0008)  
	unsigned char                                      UnknownData01_7[0x58];                                      // 0x00F0   (0x0058)  MISSED


	/// Functions
	// Function /Script/AIModule.AISystem.AILoggingVerbose
	// void AILoggingVerbose();                                                                                                 // [0x198b060] Exec|Native|Public   
	// Function /Script/AIModule.AISystem.AIIgnorePlayers
	// void AIIgnorePlayers();                                                                                                  // [0x16b0bb0] Exec|Native|Public   
};
...
/// Size: 0x0058 (88 bytes) (0x0000F8 - 0x000150) align 8 pad: 0x0000
class UBrainComponent : public UActorComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x00F8   (0x0008)  MISSED
	class UBlackboardComponent*                        BlackboardComp;                                             // 0x0100   (0x0008)  
	class AAIController*                               AIOwner;                                                    // 0x0108   (0x0008)  
	unsigned char                                      UnknownData01_7[0x40];                                      // 0x0110   (0x0040)  MISSED


	/// Functions
	// Function /Script/AIModule.BrainComponent.StopLogic
	// void StopLogic(FString reason);                                                                                          // [0x2860c60] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.StartLogic
	// void StartLogic();                                                                                                       // [0xc2fd90] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.RestartLogic
	// void RestartLogic();                                                                                                     // [0x1dfa810] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BrainComponent.IsRunning
	// bool IsRunning();                                                                                                        // [0x28e4930] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BrainComponent.IsPaused
	// bool IsPaused();                                                                                                         // [0x2860ef0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BehaviorTreeComponent
/// Size: 0x0188 (392 bytes) (0x000150 - 0x0002D8) align 8 pad: 0x0000
class UBehaviorTreeComponent : public UBrainComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x20];                                      // 0x0150   (0x0020)  MISSED
	TArray<class UBTNode*>                             NodeInstances;                                              // 0x0170   (0x0010)  
	unsigned char                                      UnknownData01_6[0x140];                                     // 0x0180   (0x0140)  MISSED
	class UBehaviorTree*                               DefaultBehaviorTreeAsset;                                   // 0x02C0   (0x0008)  
	unsigned char                                      UnknownData02_7[0x10];                                      // 0x02C8   (0x0010)  MISSED


	/// Functions
	// Function /Script/AIModule.BehaviorTreeComponent.SetDynamicSubtree
	// void SetDynamicSubtree(FGameplayTag InjectTag, class UBehaviorTree* BehaviorAsset);                                      // [0x5fa7950] Native|Public|BlueprintCallable 
	// Function /Script/AIModule.BehaviorTreeComponent.GetTagCooldownEndTime
	// float GetTagCooldownEndTime(FGameplayTag CooldownTag);                                                                   // [0x5fa7170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BehaviorTreeComponent.AddCooldownTagDuration
	// void AddCooldownTagDuration(FGameplayTag CooldownTag, float CooldownDuration, bool bAddToExistingDuration);              // [0x5fa6df0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,376) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,377) /* FMulticastInlineDelegate */ __um(OnFail);                                             // 0x0038   (0x0010)  
	...
	// void OnMoveCompleted(FAIRequestID RequestID, TEnumAsByte<EPathFollowingResult> MovementResult);                          // [0x5f9dee0] Final|Native|Public  
};
...
public:
	...
	// void UnlockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bUnlockMovement, bool UnlockAILogic);        // [0x5f9e970] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SpawnAIFromClass
	// class APawn* SpawnAIFromClass(class UObject* WorldContextObject, class UClass* PawnClass, class UBehaviorTree* BehaviorTree, FVector Location, FRotator Rotation, bool bNoCollisionFail, class AActor* Owner); // [0x5f9e6b0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SimpleMoveToLocation
	// void SimpleMoveToLocation(class AController* Controller, FVector& Goal);                                                 // [0x5f9e5f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SimpleMoveToActor
	// void SimpleMoveToActor(class AController* Controller, class AActor* Goal);                                               // [0x5f9e530] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.SendAIMessage
	// void SendAIMessage(class APawn* Target, FName Message, class UObject* MessageSource, bool bSuccess);                     // [0x5f9e1f0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.LockAIResourcesWithAnimation
	// void LockAIResourcesWithAnimation(class UAnimInstance* AnimInstance, bool bLockMovement, bool LockAILogic);              // [0x5f9d830] Final|BlueprintAuthorityOnly|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAIRotation
	// bool IsValidAIRotation(FRotator Rotation);                                                                               // [0x5f9d660] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAILocation
	// bool IsValidAILocation(FVector Location);                                                                                // [0x5f9d5d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.IsValidAIDirection
	// bool IsValidAIDirection(FVector DirectionVector);                                                                        // [0x5f9d540] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetNextNavLinkIndex
	// int32_t GetNextNavLinkIndex(class AController* Controller);                                                              // [0x5f9d150] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPathPoints
	// TArray<FVector> GetCurrentPathPoints(class AController* Controller);                                                     // [0x5f9cca0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPathIndex
	// int32_t GetCurrentPathIndex(class AController* Controller);                                                              // [0x5f9cc10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetCurrentPath
	// class UNavigationPath* GetCurrentPath(class AController* Controller);                                                    // [0x5f9cb80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetBlackboard
	// class UBlackboardComponent* GetBlackboard(class AActor* Target);                                                         // [0x5f9caf0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.GetAIController
	// class AAIController* GetAIController(class AActor* ControlledActor);                                                     // [0x5f9c940] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.AIBlueprintHelperLibrary.CreateMoveToProxyObject
	// class UAIAsyncTaskBlueprintProxy* CreateMoveToProxyObject(class UObject* WorldContextObject, class APawn* Pawn, FVector Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap); // [0x5f9c740] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
{ 
public:
	bool                                               bAutoRegisterAsSource : 1;                                  // 0x00F8:0 (0x0001)  
	unsigned char                                      UnknownData00_5[0x7];                                       // 0x00F9   (0x0007)  MISSED
	TArray<class UClass*>                              RegisterAsSourceForSenses;                                  // 0x0100   (0x0010)  


	/// Functions
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.UnregisterFromSense
	// void UnregisterFromSense(class UClass* SenseClass);                                                                      // [0x5f9eaa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.UnregisterFromPerceptionSystem
	// void UnregisterFromPerceptionSystem();                                                                                   // [0x5f9ea80] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterWithPerceptionSystem
	// void RegisterWithPerceptionSystem();                                                                                     // [0x5f9e110] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.AIPerceptionStimuliSourceComponent.RegisterForSense
	// void RegisterForSense(class UClass* SenseClass);                                                                         // [0x5f9e080] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// float OnUpdate(TArray<UAISenseEvent*>& EventsToProcess);                                                                 // [0x3a75280] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUpdated
	// void OnListenerUpdated(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);                  // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerUnregistered
	// void OnListenerUnregistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);             // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.OnListenerRegistered
	// void OnListenerRegistered(class AActor* ActorListener, class UAIPerceptionComponent* PerceptionComponent);               // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.K2_OnNewPawn
	// void K2_OnNewPawn(class APawn* NewPawn);                                                                                 // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerComponents
	// void GetAllListenerComponents(TArray<UAIPerceptionComponent*>& ListenerComponents);                                      // [0x5fa2ab0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.AISense_Blueprint.GetAllListenerActors
	// void GetAllListenerActors(TArray<AActor*>& ListenerActors);                                                              // [0x5fa29e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, FVector EventLocation, FVector HitLocation); // [0x5fa2e60] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void RequestPawnPredictionEvent(class APawn* Requestor, class AActor* PredictedActor, float PredictionTime);             // [0x5fa3480] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.AISense_Prediction.RequestControllerPredictionEvent
	// void RequestControllerPredictionEvent(class AAIController* Requestor, class AActor* PredictedActor, float PredictionTime); // [0x5fa3380] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,378) /* FMulticastInlineDelegate */ __um(OnRequestFailed);                                    // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,379) /* FMulticastInlineDelegate */ __um(OnMoveFinished);                                     // 0x0080   (0x0010)  
...
public:
	...
	// class UAITask_RunEQS* RunEQS(class AAIController* Controller, class UEnvQuery* QueryTemplate);                           // [0x5fa3580] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UBlackboardData* GetBlackboardAsset();                                                                             // [0x16a3460] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

/// Class /Script/AIModule.BlackboardComponent
/// Size: 0x0108 (264 bytes) (0x0000F8 - 0x000200) align 8 pad: 0x0000
class UBlackboardComponent : public UActorComponent
{ 
public:
	class UBrainComponent*                             BrainComp;                                                  // 0x00F8   (0x0008)  
	class UBlackboardData*                             DefaultBlackboardAsset;                                     // 0x0100   (0x0008)  
	class UBlackboardData*                             BlackboardAsset;                                            // 0x0108   (0x0008)  
	unsigned char                                      UnknownData00_6[0x20];                                      // 0x0110   (0x0020)  MISSED
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                               // 0x0130   (0x0010)  
	unsigned char                                      UnknownData01_7[0xC0];                                      // 0x0140   (0x00C0)  MISSED


	/// Functions
	// Function /Script/AIModule.BlackboardComponent.SetValueAsVector
	// void SetValueAsVector(FName& KeyName, FVector VectorValue);                                                              // [0x5fa8220] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsString
	// void SetValueAsString(FName& KeyName, FString StringValue);                                                              // [0x5fa80e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsRotator
	// void SetValueAsRotator(FName& KeyName, FRotator VectorValue);                                                            // [0x5fa7ff0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsObject
	// void SetValueAsObject(FName& KeyName, class UObject* ObjectValue);                                                       // [0x5fa7f20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsName
	// void SetValueAsName(FName& KeyName, FName NameValue);                                                                    // [0x5fa7e50] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsInt
	// void SetValueAsInt(FName& KeyName, int32_t IntValue);                                                                    // [0x5fa7d80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsFloat
	// void SetValueAsFloat(FName& KeyName, float FloatValue);                                                                  // [0x5fa7cb0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsEnum
	// void SetValueAsEnum(FName& KeyName, char EnumValue);                                                                     // [0x5fa7bd0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsClass
	// void SetValueAsClass(FName& KeyName, class UClass* ClassValue);                                                          // [0x5fa7b00] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.SetValueAsBool
	// void SetValueAsBool(FName& KeyName, bool BoolValue);                                                                     // [0x5fa7a20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BlackboardComponent.IsVectorValueSet
	// bool IsVectorValueSet(FName& KeyName);                                                                                   // [0x5fa78b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsVector
	// FVector GetValueAsVector(FName& KeyName);                                                                                // [0x5fa7800] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsString
	// FString GetValueAsString(FName& KeyName);                                                                                // [0x5fa7720] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsRotator
	// FRotator GetValueAsRotator(FName& KeyName);                                                                              // [0x5fa7670] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsObject
	// class UObject* GetValueAsObject(FName& KeyName);                                                                         // [0x5fa75d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsName
	// FName GetValueAsName(FName& KeyName);                                                                                    // [0x5fa7530] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsInt
	// int32_t GetValueAsInt(FName& KeyName);                                                                                   // [0x5fa7490] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsFloat
	// float GetValueAsFloat(FName& KeyName);                                                                                   // [0x5fa73f0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsEnum
	// char GetValueAsEnum(FName& KeyName);                                                                                     // [0x5fa7350] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsClass
	// class UClass* GetValueAsClass(FName& KeyName);                                                                           // [0x5fa72b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetValueAsBool
	// bool GetValueAsBool(FName& KeyName);                                                                                     // [0x5fa7210] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetRotationFromEntry
	// bool GetRotationFromEntry(FName& KeyName, FRotator& ResultRotation);                                                     // [0x5fa7080] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.GetLocationFromEntry
	// bool GetLocationFromEntry(FName& KeyName, FVector& ResultLocation);                                                      // [0x5fa6f90] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BlackboardComponent.ClearValue
	// void ClearValue(FName& KeyName);                                                                                         // [0x5fa6f00] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void StopUsingExternalEvent(class UBTNode* NodeOwner);                                                                   // [0x2dc9dd0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.StartUsingExternalEvent
	// void StartUsingExternalEvent(class UBTNode* NodeOwner, class AActor* OwningActor);                                       // [0x287c450] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsVector
	// void SetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FVector Value);                   // [0x5fac730] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsString
	// void SetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FString Value);                   // [0x5fac5a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsRotator
	// void SetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FRotator Value);                 // [0x5fac450] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsObject
	// void SetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UObject* Value);            // [0x5fac310] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsName
	// void SetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, FName Value);                       // [0x5fac1d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsInt
	// void SetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, int32_t Value);                      // [0x5fac090] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsFloat
	// void SetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, float Value);                      // [0x5fabf50] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsEnum
	// void SetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, char Value);                        // [0x5fabe10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsClass
	// void SetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, class UClass* Value);              // [0x5fabcd0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.SetBlackboardValueAsBool
	// void SetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key, bool Value);                        // [0x5fabb90] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.GetOwnersBlackboard
	// class UBlackboardComponent* GetOwnersBlackboard(class UBTNode* NodeOwner);                                               // [0x5fabaa0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetOwnerComponent
	// class UBehaviorTreeComponent* GetOwnerComponent(class UBTNode* NodeOwner);                                               // [0x5faba10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsVector
	// FVector GetBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x5fab900] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsString
	// FString GetBlackboardValueAsString(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                               // [0x5fab7c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsRotator
	// FRotator GetBlackboardValueAsRotator(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                             // [0x5fab6b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsObject
	// class UObject* GetBlackboardValueAsObject(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                        // [0x5fab5b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsName
	// FName GetBlackboardValueAsName(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                   // [0x5fab4a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsInt
	// int32_t GetBlackboardValueAsInt(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x5fab3a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsFloat
	// float GetBlackboardValueAsFloat(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                  // [0x5fab2a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsEnum
	// char GetBlackboardValueAsEnum(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x5fab1a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsClass
	// class UClass* GetBlackboardValueAsClass(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x5fab0a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsBool
	// bool GetBlackboardValueAsBool(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                    // [0x5faafa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.GetBlackboardValueAsActor
	// class AActor* GetBlackboardValueAsActor(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                          // [0x5faaea0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.BTFunctionLibrary.ClearBlackboardValueAsVector
	// void ClearBlackboardValueAsVector(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                // [0x5faad00] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.BTFunctionLibrary.ClearBlackboardValue
	// void ClearBlackboardValue(class UBTNode* NodeOwner, FBlackboardKeySelector& Key);                                        // [0x5faad00] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetFinishOnMessageWithId(FName MessageName, int32_t RequestID);                                                     // [0x5fac910] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.SetFinishOnMessage
	// void SetFinishOnMessage(FName MessageName);                                                                              // [0x5fac880] Final|Native|Protected|BlueprintCallable 
	...
	// bool IsTaskExecuting();                                                                                                  // [0x5fabb60] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.IsTaskAborting
	// bool IsTaskAborting();                                                                                                   // [0x5fabb30] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishExecute
	// void FinishExecute(bool bSuccess);                                                                                       // [0x5faae10] Final|Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.BTTask_BlueprintBase.FinishAbort
	// void FinishAbort();                                                                                                      // [0x5faadf0] Final|Native|Protected|BlueprintCallable 
};
...
/// Size: 0x0048 (72 bytes) (0x000298 - 0x0002E0) align 8 pad: 0x0000
class UCrowdFollowingComponent : public UPathFollowingComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x0298   (0x0018)  MISSED
	FVector                                            CrowdAgentMoveDirection;                                    // 0x02B0   (0x000C)  
	unsigned char                                      UnknownData01_7[0x24];                                      // 0x02BC   (0x0024)  MISSED


	/// Functions
	// Function /Script/AIModule.CrowdFollowingComponent.SuspendCrowdSteering
	// void SuspendCrowdSteering(bool bSuspend);                                                                                // [0x5faff50] Native|Public|BlueprintCallable 
};
...
/// Size: 0x0000 (0 bytes) (0x0003E8 - 0x0003E8) align 8 pad: 0x0000
...
public:
	...
	// void ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, FVector& ResultingLocation);        // [0x3a75280] Event|Public|HasOutParms|HasDefaults|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideSingleActor
	// void ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor*& ResultingActor);        // [0x3a75280] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideLocationsSet
	// void ProvideLocationsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<FVector>& ResultingLocationSet); // [0x3a75280] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/AIModule.EnvQueryContext_BlueprintBase.ProvideActorsSet
	// void ProvideActorsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<AActor*>& ResultingActorsSet);    // [0x3a75280] Event|Public|HasOutParms|BlueprintEvent|Const 
};
...
{ 
public:
	unsigned char                                      UnknownData00_1[0x38];                                      // 0x05D8   (0x0038)  MISSED
};

/// Class /Script/AIModule.EQSTestingPawn
/// Size: 0x0098 (152 bytes) (0x0005A8 - 0x000640) align 16 pad: 0x0000
class AEQSTestingPawn : public ACharacter
{ 
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x05A8   (0x0008)  MISSED
	class UEnvQuery*                                   QueryTemplate;                                              // 0x05B0   (0x0008)  
	TArray<FEnvNamedValue>                             QueryParams;                                                // 0x05B8   (0x0010)  
	TArray<FAIDynamicParam>                            QueryConfig;                                                // 0x05C8   (0x0010)  
	float                                              TimeLimitPerStep;                                           // 0x05D8   (0x0004)  
	int32_t                                            StepToDebugDraw;                                            // 0x05DC   (0x0004)  
	EEnvQueryHightlightMode                            HighlightMode;                                              // 0x05E0   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x05E1   (0x0003)  MISSED
	bool                                               bDrawLabels : 1;                                            // 0x05E4:0 (0x0001)  
	bool                                               bDrawFailedItems : 1;                                       // 0x05E4:1 (0x0001)  
	bool                                               bReRunQueryOnlyOnFinishedMove : 1;                          // 0x05E4:2 (0x0001)  
	bool                                               bShouldBeVisibleInGame : 1;                                 // 0x05E4:3 (0x0001)  
	bool                                               bTickDuringGame : 1;                                        // 0x05E4:4 (0x0001)  
	unsigned char                                      UnknownData02_5[0x3];                                       // 0x05E5   (0x0003)  MISSED
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                               // 0x05E8   (0x0001)  
	unsigned char                                      UnknownData03_6[0x7];                                       // 0x05E9   (0x0007)  MISSED
	FNavAgentProperties                                NavAgentProperties;                                         // 0x05F0   (0x0030)  
	unsigned char                                      UnknownData04_7[0x20];                                      // 0x0620   (0x0020)  MISSED
};
...
/// Size: 0x0030 (48 bytes) (0x000298 - 0x0002C8) align 8 pad: 0x0000
class UGridPathFollowingComponent : public UPathFollowingComponent
{ 
public:
	class UNavLocalGridManager*                        GridManager;                                                // 0x0298   (0x0008)  
	unsigned char                                      UnknownData00_7[0x28];                                      // 0x02A0   (0x0028)  MISSED
};
...
public:
	...
	// bool SetLocalNavigationGridDensity(class UObject* WorldContextObject, float CellSize);                                   // [0x5fb7310] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.RemoveLocalNavigationGrid
	// void RemoveLocalNavigationGrid(class UObject* WorldContextObject, int32_t GridId, bool bRebuildGrids);                   // [0x5fb7180] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.FindLocalNavigationGridPath
	// bool FindLocalNavigationGridPath(class UObject* WorldContextObject, FVector& Start, FVector& End, TArray<FVector>& PathPoints); // [0x5fb6900] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoints
	// int32_t AddLocalNavigationGridForPoints(class UObject* WorldContextObject, TArray<FVector>& Locations, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x5fb6660] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForPoint
	// int32_t AddLocalNavigationGridForPoint(class UObject* WorldContextObject, FVector& Location, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x5fb64a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForCapsule
	// int32_t AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x5fb6280] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AIModule.NavLocalGridManager.AddLocalNavigationGridForBox
	// int32_t AddLocalNavigationGridForBox(class UObject* WorldContextObject, FVector& Location, FVector Extent, FRotator Rotation, int32_t Radius2D, float Height, bool bRebuildGrids); // [0x5fb6040] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// TEnumAsByte<EAIRequestPriority> GetActionPriority();                                                                     // [0x5fb6b10] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AIModule.PawnAction.Finish
	// void Finish(TEnumAsByte<EPawnActionResult> WithResult);                                                                  // [0x5fb6a90] Native|Protected|BlueprintCallable 
	// Function /Script/AIModule.PawnAction.CreateActionInstance
	// class UPawnAction* CreateActionInstance(class UObject* WorldContextObject, class UClass* ActionClass);                   // [0x5fb6830] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void ActionTick(class APawn* ControlledPawn, float DeltaSeconds);                                                        // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionStart
	// void ActionStart(class APawn* ControlledPawn);                                                                           // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionResume
	// void ActionResume(class APawn* ControlledPawn);                                                                          // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionPause
	// void ActionPause(class APawn* ControlledPawn);                                                                           // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/AIModule.PawnAction_BlueprintBase.ActionFinished
	// void ActionFinished(class APawn* ControlledPawn, TEnumAsByte<EPawnActionResult> WithResult);                             // [0x3a75280] Event|Public|BlueprintEvent 
};
...
{ 
public:
	class APawn*                                       ControlledPawn;                                             // 0x00F8   (0x0008)  
	TArray<FPawnActionStack>                           ActionStacks;                                               // 0x0100   (0x0010)  
	TArray<FPawnActionEvent>                           ActionEvents;                                               // 0x0110   (0x0010)  
	class UPawnAction*                                 CurrentAction;                                              // 0x0120   (0x0008)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0128   (0x0008)  MISSED


	/// Functions
	// Function /Script/AIModule.PawnActionsComponent.K2_PushAction
	// bool K2_PushAction(class UPawnAction* NewAction, TEnumAsByte<EAIRequestPriority> Priority, class UObject* Instigator);   // [0x5fb6e40] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_PerformAction
	// bool K2_PerformAction(class APawn* Pawn, class UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);           // [0x5fb6d40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_ForceAbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_ForceAbortAction(class UPawnAction* ActionToAbort);                                // [0x5fb6ca0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnActionsComponent.K2_AbortAction
	// TEnumAsByte<EPawnActionAbortState> K2_AbortAction(class UPawnAction* ActionToAbort);                                     // [0x5fb6c00] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	float                                              HearingThreshold;                                           // 0x00F8   (0x0004)  
	float                                              LOSHearingThreshold;                                        // 0x00FC   (0x0004)  
	float                                              SightRadius;                                                // 0x0100   (0x0004)  
	float                                              SensingInterval;                                            // 0x0104   (0x0004)  
	float                                              HearingMaxSoundAge;                                         // 0x0108   (0x0004)  
	bool                                               bEnableSensingUpdates : 1;                                  // 0x010C:0 (0x0001)  
	bool                                               bOnlySensePlayers : 1;                                      // 0x010C:1 (0x0001)  
	bool                                               bSeePawns : 1;                                              // 0x010C:2 (0x0001)  
	bool                                               bHearNoises : 1;                                            // 0x010C:3 (0x0001)  
	unsigned char                                      UnknownData00_5[0xB];                                       // 0x010D   (0x000B)  MISSED
	SDK_UNDEFINED(16,380) /* FMulticastInlineDelegate */ __um(OnSeePawn);                                          // 0x0118   (0x0010)  
	SDK_UNDEFINED(16,381) /* FMulticastInlineDelegate */ __um(OnHearNoise);                                        // 0x0128   (0x0010)  
	float                                              PeripheralVisionAngle;                                      // 0x0138   (0x0004)  
	float                                              PeripheralVisionCosine;                                     // 0x013C   (0x0004)  


	/// Functions
	// Function /Script/AIModule.PawnSensingComponent.SetSensingUpdatesEnabled
	// void SetSensingUpdatesEnabled(bool bEnabled);                                                                            // [0x28c5d90] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetSensingInterval
	// void SetSensingInterval(float NewSensingInterval);                                                                       // [0x28caae0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SetPeripheralVisionAngle
	// void SetPeripheralVisionAngle(float NewPeripheralVisionAngle);                                                           // [0x5fb73e0] BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	// Function /Script/AIModule.PawnSensingComponent.SeePawnDelegate__DelegateSignature
	// void SeePawnDelegate__DelegateSignature(class APawn* Pawn);                                                              // [0x3a75280] MulticastDelegate|Public|Delegate 
	// Function /Script/AIModule.PawnSensingComponent.HearNoiseDelegate__DelegateSignature
	// void HearNoiseDelegate__DelegateSignature(class APawn* Instigator, FVector& Location, float Volume);                     // [0x3a75280] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionCosine
	// float GetPeripheralVisionCosine();                                                                                       // [0x29bbc70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AIModule.PawnSensingComponent.GetPeripheralVisionAngle
	// float GetPeripheralVisionAngle();                                                                                        // [0x1da7070] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
	...
	SDK_UNDEFINED(8,382) /* TWeakObjectPtr<AActor*> */ __um(Target);                                               // 0x0004   (0x0008)  
...
static_assert(sizeof(AAIController) == 0x03E8); // 1000 bytes (0x000358 - 0x0003E8)
static_assert(sizeof(ANavLinkProxy) == 0x0330); // 816 bytes (0x0002E0 - 0x000330)
static_assert(sizeof(UPathFollowingComponent) == 0x0298); // 664 bytes (0x0000F8 - 0x000298)
...
static_assert(sizeof(UAIPerceptionComponent) == 0x01D8); // 472 bytes (0x0000F8 - 0x0001D8)
...
static_assert(sizeof(UAISystem) == 0x0148); // 328 bytes (0x000058 - 0x000148)
...
static_assert(sizeof(UBrainComponent) == 0x0150); // 336 bytes (0x0000F8 - 0x000150)
static_assert(sizeof(UBehaviorTreeComponent) == 0x02D8); // 728 bytes (0x000150 - 0x0002D8)
...
static_assert(sizeof(UAIPerceptionStimuliSourceComponent) == 0x0110); // 272 bytes (0x0000F8 - 0x000110)
...
static_assert(sizeof(UBlackboardComponent) == 0x0200); // 512 bytes (0x0000F8 - 0x000200)
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x02E0); // 736 bytes (0x000298 - 0x0002E0)
...
static_assert(sizeof(ADetourCrowdAIController) == 0x03E8); // 1000 bytes (0x0003E8 - 0x0003E8)
...
static_assert(sizeof(UEQSRenderingComponent) == 0x0610); // 1552 bytes (0x0005D8 - 0x000610)
static_assert(sizeof(AEQSTestingPawn) == 0x0640); // 1600 bytes (0x0005A8 - 0x000640)
static_assert(sizeof(UGenericTeamAgentInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(AGridPathAIController) == 0x03E8); // 1000 bytes (0x0003E8 - 0x0003E8)
static_assert(sizeof(UGridPathFollowingComponent) == 0x02C8); // 712 bytes (0x000298 - 0x0002C8)
...
static_assert(sizeof(UPawnActionsComponent) == 0x0130); // 304 bytes (0x0000F8 - 0x000130)
static_assert(sizeof(UPawnSensingComponent) == 0x0140); // 320 bytes (0x0000F8 - 0x000140)
...
static_assert(offsetof(AAIController, PathFollowingComponent) == 0x0398);
static_assert(offsetof(AAIController, BrainComponent) == 0x03A0);
static_assert(offsetof(AAIController, PerceptionComponent) == 0x03A8);
static_assert(offsetof(AAIController, ActionsComp) == 0x03B0);
static_assert(offsetof(AAIController, Blackboard) == 0x03B8);
static_assert(offsetof(AAIController, CachedGameplayTasksComponent) == 0x03C0);
static_assert(offsetof(AAIController, DefaultNavigationFilterClass) == 0x03C8);
static_assert(offsetof(ANavLinkProxy, PointLinks) == 0x02F0);
static_assert(offsetof(ANavLinkProxy, SegmentLinks) == 0x0300);
static_assert(offsetof(ANavLinkProxy, SmartLinkComp) == 0x0310);
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x0130);
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x0140);
...
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x00F8);
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x0108);
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x0120);
...
static_assert(offsetof(FAINoiseEvent, NoiseRelator) == 0x0020);
static_assert(offsetof(FAINoiseEvent, Tag) == 0x0028);
...
static_assert(offsetof(UAISystem, EnvQueryManagerClassName) == 0x0070);
static_assert(offsetof(UAISystem, HotSpotManagerClassName) == 0x0088);
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x00B4);
static_assert(offsetof(UAISystem, BehaviorTreeManager) == 0x00B8);
static_assert(offsetof(UAISystem, EnvironmentQueryManager) == 0x00C0);
static_assert(offsetof(UAISystem, PerceptionSystem) == 0x00C8);
static_assert(offsetof(UAISystem, AllProxyObjects) == 0x00D0);
static_assert(offsetof(UAISystem, HotSpotManager) == 0x00E0);
static_assert(offsetof(UAISystem, NavLocalGrids) == 0x00E8);
...
static_assert(offsetof(UBrainComponent, BlackboardComp) == 0x0100);
static_assert(offsetof(UBrainComponent, AIOwner) == 0x0108);
static_assert(offsetof(UBehaviorTreeComponent, NodeInstances) == 0x0170);
static_assert(offsetof(UBehaviorTreeComponent, DefaultBehaviorTreeAsset) == 0x02C0);
static_assert(offsetof(UAIDataProvider_QueryParams, ParamName) == 0x0028);
static_assert(offsetof(UAIPerceptionStimuliSourceComponent, RegisterAsSourceForSenses) == 0x0100);
...
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x00F8);
static_assert(offsetof(UBlackboardComponent, DefaultBlackboardAsset) == 0x0100);
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x0108);
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x0130);
static_assert(offsetof(FBlackboardEntry, EntryName) == 0x0000);
static_assert(offsetof(FBlackboardEntry, KeyType) == 0x0008);
static_assert(offsetof(FBlackboardEntry, Category) == 0x0014);
...
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x02B0);
...
static_assert(offsetof(AEQSTestingPawn, QueryTemplate) == 0x05B0);
static_assert(offsetof(AEQSTestingPawn, QueryParams) == 0x05B8);
static_assert(offsetof(AEQSTestingPawn, QueryConfig) == 0x05C8);
static_assert(offsetof(AEQSTestingPawn, HighlightMode) == 0x05E0);
static_assert(offsetof(AEQSTestingPawn, QueryingMode) == 0x05E8);
static_assert(offsetof(AEQSTestingPawn, NavAgentProperties) == 0x05F0);
static_assert(offsetof(UGridPathFollowingComponent, GridManager) == 0x0298);
...
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x00F8);
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x0100);
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x0110);
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x0120);
