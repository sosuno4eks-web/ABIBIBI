...
public:
	...
	// void K2_TwoBoneIK(FVector& RootPos, FVector& JointPos, FVector& EndPos, FVector& JointTarget, FVector& Effector, FVector& OutJointPos, FVector& OutEndPos, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale); // [0x4da8900] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_StartProfilingTimer
	// void K2_StartProfilingTimer();                                                                                           // [0x4da88e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_MakePerlinNoiseVectorAndRemap
	// FVector K2_MakePerlinNoiseVectorAndRemap(float X, float Y, float Z, float RangeOutMinX, float RangeOutMaxX, float RangeOutMinY, float RangeOutMaxY, float RangeOutMinZ, float RangeOutMaxZ); // [0x4da8600] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_MakePerlinNoiseAndRemap
	// float K2_MakePerlinNoiseAndRemap(float Value, float RangeOutMin, float RangeOutMax);                                     // [0x4da84e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_LookAt
	// FTransform K2_LookAt(FTransform& CurrentTransform, FVector& TargetPosition, FVector LookAtVector, bool bUseUpVector, FVector UpVector, float ClampConeInDegree); // [0x4da8250] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_EndProfilingTimer
	// float K2_EndProfilingTimer(bool bLog, FString LogPrefix);                                                                // [0x4da8160] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DistanceBetweenTwoSocketsAndMapRange
	// float K2_DistanceBetweenTwoSocketsAndMapRange(class USkeletalMeshComponent* Component, FName SocketOrBoneNameA, TEnumAsByte<ERelativeTransformSpace> SocketSpaceA, FName SocketOrBoneNameB, TEnumAsByte<ERelativeTransformSpace> SocketSpaceB, bool bRemapRange, float InRangeMin, float InRangeMax, float OutRangeMin, float OutRangeMax); // [0x4da7e70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DirectionBetweenSockets
	// FVector K2_DirectionBetweenSockets(class USkeletalMeshComponent* Component, FName SocketOrBoneNameFrom, FName SocketOrBoneNameTo); // [0x4da7d60] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromSockets
	// float K2_CalculateVelocityFromSockets(float DeltaSeconds, class USkeletalMeshComponent* Component, FName SocketOrBoneName, FName ReferenceSocketOrBone, TEnumAsByte<ERelativeTransformSpace> SocketSpace, FVector OffsetInBoneSpace, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax, EEasingFuncType EasingType, FRuntimeFloatCurve& CustomCurve); // [0x4da7900] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromPositionHistory
	// float K2_CalculateVelocityFromPositionHistory(float DeltaSeconds, FVector position, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax); // [0x4da76e0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,448) /* FMulticastInlineDelegate */ __um(OnCompleted);                                        // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,449) /* FMulticastInlineDelegate */ __um(OnBlendOut);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,450) /* FMulticastInlineDelegate */ __um(OnInterrupted);                                      // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,451) /* FMulticastInlineDelegate */ __um(OnNotifyBegin);                                      // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,452) /* FMulticastInlineDelegate */ __um(OnNotifyEnd);                                        // 0x0068   (0x0010)  
	...
	// void OnNotifyEndReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                   // [0x4da8ed0] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBeginReceived
	// void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload);                 // [0x4da8de0] Final|Native|Protected|HasOutParms 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageEnded
	// void OnMontageEnded(class UAnimMontage* Montage, bool bInterrupted);                                                     // [0x4da8d10] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnMontageBlendingOut
	// void OnMontageBlendingOut(class UAnimMontage* Montage, bool bInterrupted);                                               // [0x4da8c40] Final|Native|Protected 
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.CreateProxyObjectForPlayMontage
	// class UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(class USkeletalMeshComponent* InSkeletalMeshComponent, class UAnimMontage* MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection); // [0x4da7550] Final|Native|Static|Public|BlueprintCallable 
};
...
/// Size: 0x02A0 (672 bytes) (0x000860 - 0x000B00) align 16 pad: 0x0000
struct FAnimSequencerInstanceProxy : FAnimInstanceProxy
{ 
	unsigned char                                      UnknownData00_1[0x2A0];                                     // 0x0860   (0x02A0)  MISSED
};
...
/// Size: 0x00E8 (232 bytes) (0x000120 - 0x000208) align 8 pad: 0x0000
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x2];                                       // 0x0132   (0x0002)  MISSED
	float                                              StartPosition;                                              // 0x0134   (0x0004)  
	class UBlendSpaceBase*                             BlendSpace;                                                 // 0x0138   (0x0008)  
	bool                                               bResetPlayTimeWhenStartPositionChanges;                     // 0x0140   (0x0001)  
	bool                                               bResetAccumulateTimeWhenActive;                             // 0x0141   (0x0001)  
	unsigned char                                      UnknownData01_6[0x6];                                       // 0x0142   (0x0006)  MISSED
	bool                                               bUseOverrideInterpolationParam;                             // 0x0148   (0x0001)  
	unsigned char                                      UnknownData02_6[0x3];                                       // 0x0149   (0x0003)  MISSED
	FInterpolationParameter                            OverrideInterpolationParam_X;                               // 0x014C   (0x0008)  
	FInterpolationParameter                            OverrideInterpolationParam_Y;                               // 0x0154   (0x0008)  
	unsigned char                                      UnknownData03_6[0x8C];                                      // 0x015C   (0x008C)  MISSED
	class UBlendSpaceBase*                             PreviousBlendSpace;                                         // 0x01E8   (0x0008)  
	float                                              PreviousStartPosition;                                      // 0x01F0   (0x0004)  
	unsigned char                                      UnknownData04_6[0xC];                                       // 0x01F4   (0x000C)  MISSED
	class UAnimSequence*                               LastCachedAnimSequence;                                     // 0x0200   (0x0008)  
};

/// Struct /Script/AnimGraphRuntime.AnimNode_AimOffsetLookAt
/// Size: 0x00D8 (216 bytes) (0x000208 - 0x0002E0) align 16 pad: 0x0000
struct FAnimNode_AimOffsetLookAt : FAnimNode_BlendSpacePlayer
{ 
	unsigned char                                      UnknownData00_3[0x68];                                      // 0x0208   (0x0068)  MISSED
...
/// Size: 0x03C0 (960 bytes) (0x0000D0 - 0x000490) align 16 pad: 0x0000
...
{ 
	...
	AnimPhysCollisionType                              CollisionType;                                              // 0x0250   (0x0001)  
	AnimPhysSimSpaceType                               SimulationSpace;                                            // 0x0251   (0x0001)  
	unsigned char                                      UnknownData02_6[0x2];                                       // 0x0252   (0x0002)  MISSED
	bool                                               bUseSphericalLimits : 1;                                    // 0x0254:0 (0x0001)  
	bool                                               bUsePlanarLimit : 1;                                        // 0x0254:1 (0x0001)  
	bool                                               bDoUpdate : 1;                                              // 0x0254:2 (0x0001)  
	bool                                               bDoEval : 1;                                                // 0x0254:3 (0x0001)  
	bool                                               bOverrideLinearDamping : 1;                                 // 0x0254:4 (0x0001)  
	bool                                               bOverrideAngularBias : 1;                                   // 0x0254:5 (0x0001)  
	bool                                               bOverrideAngularDamping : 1;                                // 0x0254:6 (0x0001)  
	bool                                               bEnableWind : 1;                                            // 0x0254:7 (0x0001)  
	unsigned char                                      UnknownBit03 : 1;                                           // 0x0255:0 (0x0001)  MISSED
	bool                                               bUseGravityOverride : 1;                                    // 0x0255:1 (0x0001)  
	bool                                               bLinearSpring : 1;                                          // 0x0255:2 (0x0001)  
	bool                                               bAngularSpring : 1;                                         // 0x0255:3 (0x0001)  
	bool                                               bClamp : 1;                                                 // 0x0255:4 (0x0001)  
	unsigned char                                      UnknownData04_5[0x2];                                       // 0x0256   (0x0002)  MISSED
	...
	bool                                               bChain : 1;                                                 // 0x0298:0 (0x0001)  
	unsigned char                                      UnknownData05_5[0x7];                                       // 0x0299   (0x0007)  MISSED
	FRotationRetargetingInfo                           RetargetingSettings;                                        // 0x02A0   (0x0130)  
	unsigned char                                      UnknownData06_7[0xC0];                                      // 0x03D0   (0x00C0)  MISSED
};
...
/// Size: 0x0008 (8 bytes) (0x000208 - 0x000210) align 8 pad: 0x0000
...
{ 
	...
	class UCurveFloat*                                 DrivingCurve;                                               // 0x00E0   (0x0008)  
	...
	EDrivenDestinationMode                             DestinationMode;                                            // 0x0114   (0x0001)  
	EDrivenBoneModificationMode                        ModificationMode;                                           // 0x0115   (0x0001)  
	TEnumAsByte<EComponentType>                        SourceComponent;                                            // 0x0116   (0x0001)  
	bool                                               bUseRange : 1;                                              // 0x0117:0 (0x0001)  
	bool                                               bAffectTargetTranslationX : 1;                              // 0x0117:1 (0x0001)  
	bool                                               bAffectTargetTranslationY : 1;                              // 0x0117:2 (0x0001)  
	bool                                               bAffectTargetTranslationZ : 1;                              // 0x0117:3 (0x0001)  
	bool                                               bAffectTargetRotationX : 1;                                 // 0x0117:4 (0x0001)  
	bool                                               bAffectTargetRotationY : 1;                                 // 0x0117:5 (0x0001)  
	bool                                               bAffectTargetRotationZ : 1;                                 // 0x0117:6 (0x0001)  
	bool                                               bAffectTargetScaleX : 1;                                    // 0x0117:7 (0x0001)  
	bool                                               bAffectTargetScaleY : 1;                                    // 0x0118:0 (0x0001)  
	bool                                               bAffectTargetScaleZ : 1;                                    // 0x0118:1 (0x0001)  
	unsigned char                                      UnknownData00_7[0x7];                                       // 0x0119   (0x0007)  MISSED
};

/// Struct /Script/AnimGraphRuntime.AnimNode_CCDIK
/// Size: 0x00B0 (176 bytes) (0x0000D0 - 0x000180) align 16 pad: 0x0000
...
/// Size: 0x0028 (40 bytes) (0x0000D0 - 0x0000F8) align 8 pad: 0x0000
...
{ 
	...
	TEnumAsByte<EBoneControlSpace>                     ControlSpace;                                               // 0x00F3   (0x0001)  
...
{ 
	...
	bool                                               bCopyRotation;                                              // 0x00F1   (0x0001)  
	bool                                               bCopyScale;                                                 // 0x00F2   (0x0001)  
	CopyBoneDeltaMode                                  CopyMode;                                                   // 0x00F3   (0x0001)  
...
{ 
	SDK_UNDEFINED(8,453) /* TWeakObjectPtr<USkeletalMeshComponent*> */ __um(SourceMeshComponent);                  // 0x0010   (0x0008)  
...
{ 
	...
	SDK_UNDEFINED(16,454) /* TScriptInterface<Class> */ __um(CurveSource);                                         // 0x0030   (0x0010)  
};

/// Struct /Script/AnimGraphRuntime.AnimNode_Fabrik
/// Size: 0x00C0 (192 bytes) (0x0000D0 - 0x000190) align 16 pad: 0x0000
...
{ 
	...
	unsigned char                                      UnknownData01_7[0x34];                                      // 0x017C   (0x0034)  MISSED
};
...
/// Size: 0x0088 (136 bytes) (0x0000D0 - 0x000158) align 8 pad: 0x0000
...
{ 
	...
	TEnumAsByte<EBoneModificationMode>                 TranslationMode;                                            // 0x0104   (0x0001)  
	TEnumAsByte<EBoneModificationMode>                 RotationMode;                                               // 0x0105   (0x0001)  
	TEnumAsByte<EBoneModificationMode>                 ScaleMode;                                                  // 0x0106   (0x0001)  
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                           // 0x0107   (0x0001)  
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                              // 0x0108   (0x0001)  
	TEnumAsByte<EBoneControlSpace>                     ScaleSpace;                                                 // 0x0109   (0x0001)  
...
{ 
	...
	TEnumAsByte<EBoneControlSpace>                     DisplaySpace;                                               // 0x00E0   (0x0001)  
...
{ 
	...
	unsigned char                                      UnknownData00_7[0xC];                                       // 0x0174   (0x000C)  MISSED
};
...
/// Size: 0x00B8 (184 bytes) (0x000168 - 0x000220) align 8 pad: 0x0000
...
{ 
	...
	EPoseDriverSource                                  DriveSource;                                                // 0x0214   (0x0001)  
	EPoseDriverOutput                                  DriveOutput;                                                // 0x0215   (0x0001)  
	bool                                               bOnlyDriveSelectedBones : 1;                                // 0x0216:0 (0x0001)  
	unsigned char                                      UnknownData01_5[0x1];                                       // 0x0217   (0x0001)  MISSED
...
/// Struct /Script/AnimGraphRuntime.RefPoseLimit
...
/// Struct /Script/AnimGraphRuntime.PostPhysicsClampSettings
/// Size: 0x0010 (16 bytes) (0x000000 - 0x000010) align 4 pad: 0x0000
struct FPostPhysicsClampSettings
{ 
	bool                                               bEnableCorrection_Manual : 1;                               // 0x0000:0 (0x0001)  
	bool                                               bEnableCorrection_Auto : 1;                                 // 0x0000:1 (0x0001)  
...
/// Size: 0x06C0 (1728 bytes) (0x0000D0 - 0x000790) align 16 pad: 0x0000
...
{ 
	...
	unsigned char                                      UnknownData01_6[0x98];                                      // 0x00E0   (0x0098)  MISSED
	...
	TEnumAsByte<ECollisionChannel>                     OverlapChannel;                                             // 0x0208   (0x0001)  
	ESimulationSpace                                   SimulationSpace;                                            // 0x0209   (0x0001)  
	bool                                               bForceDisableCollisionBetweenConstraintBodies;              // 0x020A   (0x0001)  
	unsigned char                                      UnknownData02_6[0x1];                                       // 0x020B   (0x0001)  MISSED
	bool                                               bEnableWorldGeometry : 1;                                   // 0x020C:0 (0x0001)  
	bool                                               bOverrideWorldGravity : 1;                                  // 0x020C:1 (0x0001)  
	bool                                               bTransferBoneVelocities : 1;                                // 0x020C:2 (0x0001)  
	bool                                               bFreezeIncomingPoseOnStart : 1;                             // 0x020C:3 (0x0001)  
	bool                                               bClampLinearTranslationLimitToRefPose : 1;                  // 0x020C:4 (0x0001)  
	...
	bool                                               bEnableExternalCollision : 1;                               // 0x0218:0 (0x0001)  
	unsigned char                                      UnknownData04_5[0x3];                                       // 0x0219   (0x0003)  MISSED
	FBoneReference                                     ExternalCollisionBone;                                      // 0x021C   (0x0010)  
	unsigned char                                      UnknownData05_6[0x4];                                       // 0x022C   (0x0004)  MISSED
	class USkeletalMeshComponent*                      ExternalCollisionTarget;                                    // 0x0230   (0x0008)  
	class USkeletalMeshComponent*                      ExternalCollisionTargetCached;                              // 0x0238   (0x0008)  
	unsigned char                                      UnknownData06_6[0x58];                                      // 0x0240   (0x0058)  MISSED
	TArray<FRefPoseLimit>                              RefPoseLimits;                                              // 0x0298   (0x0010)  
	char                                               EffectBodyIndex;                                            // 0x02A8   (0x0001)  
	unsigned char                                      UnknownData07_6[0x3];                                       // 0x02A9   (0x0003)  MISSED
	FPostPhysicsClampSettings                          WorldSpaceCorrection_Roll;                                  // 0x02AC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_X;                                     // 0x02BC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_Y;                                     // 0x02CC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_Z;                                     // 0x02DC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_Pitch;                                 // 0x02EC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_Yaw;                                   // 0x02FC   (0x0010)  
	FPostPhysicsClampSettings                          LocalSpaceCorrection_Roll;                                  // 0x030C   (0x0010)  
	bool                                               bLimitLinearVelocity_Simulation;                            // 0x031C   (0x0001)  
	unsigned char                                      UnknownData08_6[0x3];                                       // 0x031D   (0x0003)  MISSED
	FVector                                            MaxLinearVelocity_Simulation;                               // 0x0320   (0x000C)  
	bool                                               bLimitAngularVelocity_Simulation;                           // 0x032C   (0x0001)  
	unsigned char                                      UnknownData09_6[0x3];                                       // 0x032D   (0x0003)  MISSED
	FVector                                            MaxAngularVelocity_Simulation;                              // 0x0330   (0x000C)  
	bool                                               bPrintTransformAfterPhysics;                                // 0x033C   (0x0001)  
	char                                               PrintBodyIndex;                                             // 0x033D   (0x0001)  
	bool                                               bEnableDebug_Simulation;                                    // 0x033E   (0x0001)  
	unsigned char                                      UnknownData10_7[0x451];                                     // 0x033F   (0x0451)  MISSED
};
...
{ 
	...
	TEnumAsByte<EBoneAxis>                             RotationAxisToRefer;                                        // 0x00F4   (0x0001)  
	bool                                               bIsAdditive;                                                // 0x00F5   (0x0001)  
	unsigned char                                      UnknownData00_7[0x2];                                       // 0x00F6   (0x0002)  MISSED
};

/// Struct /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpace
/// Size: 0x00A8 (168 bytes) (0x000208 - 0x0002B0) align 8 pad: 0x0000
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x02A8   (0x0004)  MISSED
	EAnimAlphaInputType                                AlphaInputType;                                             // 0x02AC   (0x0001)  
	bool                                               bAlphaBoolEnabled;                                          // 0x02AD   (0x0001)  
	unsigned char                                      UnknownData01_7[0x2];                                       // 0x02AE   (0x0002)  MISSED
};
...
{ 
	class UAnimSequenceBase*                           Sequence;                                                   // 0x0120   (0x0008)  
	float                                              ExplicitTime;                                               // 0x0128   (0x0004)  
	bool                                               bShouldLoop;                                                // 0x012C   (0x0001)  
	bool                                               bTeleportToExplicitTime;                                    // 0x012D   (0x0001)  
	TEnumAsByte<ESequenceEvalReinit>                   ReinitializationBehavior;                                   // 0x012E   (0x0001)  
	...
	class UAnimSequenceBase*                           LastPlayAnimSeq;                                            // 0x0138   (0x0008)  
};
...
/// Size: 0x01A8 (424 bytes) (0x0000D0 - 0x000278) align 8 pad: 0x0000
...
{ 
	...
	ESplineBoneAxis                                    BoneAxis;                                                   // 0x00F0   (0x0001)  
	...
	unsigned char                                      UnknownData02_7[0x128];                                     // 0x0150   (0x0128)  MISSED
};
...
{ 
	...
	unsigned char                                      UnknownData00_6[0x3C];                                      // 0x00F0   (0x003C)  MISSED
	bool                                               bLimitDisplacement : 1;                                     // 0x012C:0 (0x0001)  
	bool                                               bTranslateX : 1;                                            // 0x012C:1 (0x0001)  
	bool                                               bTranslateY : 1;                                            // 0x012C:2 (0x0001)  
	bool                                               bTranslateZ : 1;                                            // 0x012C:3 (0x0001)  
	bool                                               bRotateX : 1;                                               // 0x012C:4 (0x0001)  
	bool                                               bRotateY : 1;                                               // 0x012C:5 (0x0001)  
	bool                                               bRotateZ : 1;                                               // 0x012C:6 (0x0001)  
	unsigned char                                      UnknownData01_7[0x3];                                       // 0x012D   (0x0003)  MISSED
};
...
/// Size: 0x0190 (400 bytes) (0x0000D0 - 0x000260) align 16 pad: 0x0000
...
/// Size: 0x0070 (112 bytes) (0x0000D0 - 0x000140) align 8 pad: 0x0000
...
/// Size: 0x0120 (288 bytes) (0x0000D0 - 0x0001F0) align 16 pad: 0x0000
...
{ 
	...
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                      // 0x01E0   (0x0001)  
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                   // 0x01E1   (0x0001)  
	bool                                               bAllowStretching : 1;                                       // 0x01E2:0 (0x0001)  
	bool                                               bTakeRotationFromEffectorSpace : 1;                         // 0x01E2:1 (0x0001)  
	bool                                               bMaintainEffectorRelRot : 1;                                // 0x01E2:2 (0x0001)  
	bool                                               bAllowTwist : 1;                                            // 0x01E2:3 (0x0001)  
	unsigned char                                      UnknownData02_7[0xD];                                       // 0x01E3   (0x000D)  MISSED
};
...
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x0B00); // 2816 bytes (0x000860 - 0x000B00)
static_assert(sizeof(FAnimNode_SkeletalControlBase) == 0x00D0); // 208 bytes (0x000010 - 0x0000D0)
...
static_assert(sizeof(FAnimNode_BlendSpacePlayer) == 0x0208); // 520 bytes (0x000120 - 0x000208)
static_assert(sizeof(FAnimNode_AimOffsetLookAt) == 0x02E0); // 736 bytes (0x000208 - 0x0002E0)
...
static_assert(sizeof(FAnimNode_AnimDynamics) == 0x0490); // 1168 bytes (0x0000D0 - 0x000490)
...
static_assert(sizeof(FAnimNode_ApplyLimits) == 0x0110); // 272 bytes (0x0000D0 - 0x000110)
...
static_assert(sizeof(FAnimNode_BlendSpaceEvaluator) == 0x0210); // 528 bytes (0x000208 - 0x000210)
static_assert(sizeof(FAnimNode_BoneDrivenController) == 0x0120); // 288 bytes (0x0000D0 - 0x000120)
static_assert(sizeof(FAnimNode_CCDIK) == 0x0180); // 384 bytes (0x0000D0 - 0x000180)
static_assert(sizeof(FConstraint) == 0x001C); // 28 bytes (0x000000 - 0x00001C)
static_assert(sizeof(FAnimNode_Constraint) == 0x0110); // 272 bytes (0x0000D0 - 0x000110)
static_assert(sizeof(FAnimNode_CopyBone) == 0x00F8); // 248 bytes (0x0000D0 - 0x0000F8)
static_assert(sizeof(FAnimNode_CopyBoneDelta) == 0x0100); // 256 bytes (0x0000D0 - 0x000100)
...
static_assert(sizeof(FAnimNode_Fabrik) == 0x0190); // 400 bytes (0x0000D0 - 0x000190)
static_assert(sizeof(FAnimNode_HandIKRetargeting) == 0x0128); // 296 bytes (0x0000D0 - 0x000128)
...
static_assert(sizeof(FAnimNode_LegIK) == 0x0100); // 256 bytes (0x0000D0 - 0x000100)
...
static_assert(sizeof(FAnimNode_LookAt) == 0x01B0); // 432 bytes (0x0000D0 - 0x0001B0)
static_assert(sizeof(FAnimNode_MakeDynamicAdditive) == 0x0038); // 56 bytes (0x000010 - 0x000038)
static_assert(sizeof(FAnimNode_ModifyBone) == 0x0158); // 344 bytes (0x0000D0 - 0x000158)
static_assert(sizeof(FAnimNode_ModifyCurve) == 0x0090); // 144 bytes (0x000010 - 0x000090)
static_assert(sizeof(FAnimNode_MultiWayBlend) == 0x0050); // 80 bytes (0x000010 - 0x000050)
static_assert(sizeof(FAnimNode_ObserveBone) == 0x0108); // 264 bytes (0x0000D0 - 0x000108)
static_assert(sizeof(FAnimNode_PoseHandler) == 0x0168); // 360 bytes (0x000120 - 0x000168)
static_assert(sizeof(FAnimNode_PoseBlendNode) == 0x0188); // 392 bytes (0x000168 - 0x000188)
static_assert(sizeof(FAnimNode_PoseByName) == 0x0180); // 384 bytes (0x000168 - 0x000180)
...
static_assert(sizeof(FAnimNode_PoseDriver) == 0x0220); // 544 bytes (0x000168 - 0x000220)
...
static_assert(sizeof(FAnimNode_ResetRoot) == 0x00E0); // 224 bytes (0x0000D0 - 0x0000E0)
static_assert(sizeof(FSimSpaceSettings) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(FRefPoseLimit) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(FPostPhysicsClampSettings) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAnimNode_RigidBody) == 0x0790); // 1936 bytes (0x0000D0 - 0x000790)
static_assert(sizeof(FAnimNode_RotateRootBone) == 0x00A0); // 160 bytes (0x000010 - 0x0000A0)
static_assert(sizeof(FAnimNode_RotationMultiplier) == 0x00F8); // 248 bytes (0x0000D0 - 0x0000F8)
static_assert(sizeof(FAnimNode_RotationOffsetBlendSpace) == 0x02B0); // 688 bytes (0x000208 - 0x0002B0)
static_assert(sizeof(FAnimNode_ScaleChainLength) == 0x0078); // 120 bytes (0x000010 - 0x000078)
static_assert(sizeof(FAnimNode_SequenceEvaluator) == 0x0140); // 320 bytes (0x000120 - 0x000140)
static_assert(sizeof(FAnimNode_Slot) == 0x0048); // 72 bytes (0x000010 - 0x000048)
static_assert(sizeof(FAnimNode_SplineIK) == 0x0278); // 632 bytes (0x0000D0 - 0x000278)
static_assert(sizeof(FSplineIKCachedBoneData) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(FAnimNode_SpringBone) == 0x0130); // 304 bytes (0x0000D0 - 0x000130)
...
static_assert(sizeof(FAnimNode_Trail) == 0x0260); // 608 bytes (0x0000D0 - 0x000260)
static_assert(sizeof(FReferenceBoneFrame) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FAnimNode_TwistCorrectiveNode) == 0x0140); // 320 bytes (0x0000D0 - 0x000140)
static_assert(sizeof(FAnimNode_TwoBoneIK) == 0x01F0); // 496 bytes (0x0000D0 - 0x0001F0)
...
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaBoolBlend) == 0x0040);
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaCurveName) == 0x0088);
static_assert(offsetof(FAnimNode_SkeletalControlBase, AlphaScaleBiasClamp) == 0x0090);
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer, BlendSpace) == 0x0138);
static_assert(offsetof(FAnimNode_BlendSpacePlayer, OverrideInterpolationParam_X) == 0x014C);
static_assert(offsetof(FAnimNode_BlendSpacePlayer, OverrideInterpolationParam_Y) == 0x0154);
static_assert(offsetof(FAnimNode_BlendSpacePlayer, PreviousBlendSpace) == 0x01E8);
static_assert(offsetof(FAnimNode_BlendSpacePlayer, LastCachedAnimSequence) == 0x0200);
static_assert(offsetof(FAnimNode_AimOffsetLookAt, BasePose) == 0x0270);
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SourceSocketName) == 0x0284);
static_assert(offsetof(FAnimNode_AimOffsetLookAt, PivotSocketName) == 0x028C);
static_assert(offsetof(FAnimNode_AimOffsetLookAt, LookAtLocation) == 0x0294);
static_assert(offsetof(FAnimNode_AimOffsetLookAt, SocketAxis) == 0x02A0);
...
static_assert(offsetof(FAnimNode_AnimDynamics, RelativeSpaceBone) == 0x0140);
static_assert(offsetof(FAnimNode_AnimDynamics, BoundBone) == 0x0150);
static_assert(offsetof(FAnimNode_AnimDynamics, ChainEnd) == 0x0160);
static_assert(offsetof(FAnimNode_AnimDynamics, BoxExtents) == 0x0170);
static_assert(offsetof(FAnimNode_AnimDynamics, LocalJointOffset) == 0x017C);
static_assert(offsetof(FAnimNode_AnimDynamics, GravityOverride) == 0x018C);
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentLinearAccScale) == 0x01A4);
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentLinearVelScale) == 0x01B0);
static_assert(offsetof(FAnimNode_AnimDynamics, ComponentAppliedLinearAccClamp) == 0x01BC);
static_assert(offsetof(FAnimNode_AnimDynamics, ConstraintSetup) == 0x01D4);
static_assert(offsetof(FAnimNode_AnimDynamics, SphericalLimits) == 0x0220);
static_assert(offsetof(FAnimNode_AnimDynamics, ExternalForce) == 0x0234);
static_assert(offsetof(FAnimNode_AnimDynamics, PlanarLimits) == 0x0240);
static_assert(offsetof(FAnimNode_AnimDynamics, CollisionType) == 0x0250);
static_assert(offsetof(FAnimNode_AnimDynamics, SimulationSpace) == 0x0251);
static_assert(offsetof(FAnimNode_AnimDynamics, ClampReferenceBone) == 0x0258);
static_assert(offsetof(FAnimNode_AnimDynamics, ClampTranslationMin) == 0x0268);
static_assert(offsetof(FAnimNode_AnimDynamics, ClampTranslationMax) == 0x0274);
static_assert(offsetof(FAnimNode_AnimDynamics, ClampRotationMin) == 0x0280);
static_assert(offsetof(FAnimNode_AnimDynamics, ClampRotationMax) == 0x028C);
static_assert(offsetof(FAnimNode_AnimDynamics, RetargetingSettings) == 0x02A0);
...
static_assert(offsetof(FAnimNode_ApplyLimits, AngularRangeLimits) == 0x00D0);
static_assert(offsetof(FAnimNode_ApplyLimits, AngularOffsets) == 0x00E0);
static_assert(offsetof(FAnimNode_ApplyLimits, LocationRangeLimits) == 0x00F0);
static_assert(offsetof(FAnimNode_ApplyLimits, LocationOffsets) == 0x0100);
...
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceBone) == 0x00D0);
static_assert(offsetof(FAnimNode_BoneDrivenController, DrivingCurve) == 0x00E0);
static_assert(offsetof(FAnimNode_BoneDrivenController, ParameterName) == 0x00FC);
static_assert(offsetof(FAnimNode_BoneDrivenController, TargetBone) == 0x0104);
static_assert(offsetof(FAnimNode_BoneDrivenController, DestinationMode) == 0x0114);
static_assert(offsetof(FAnimNode_BoneDrivenController, ModificationMode) == 0x0115);
static_assert(offsetof(FAnimNode_BoneDrivenController, SourceComponent) == 0x0116);
static_assert(offsetof(FAnimNode_CCDIK, EffectorLocation) == 0x00D0);
static_assert(offsetof(FAnimNode_CCDIK, EffectorLocationSpace) == 0x00DC);
...
static_assert(offsetof(FAnimNode_Constraint, BoneToModify) == 0x00D0);
static_assert(offsetof(FAnimNode_Constraint, ConstraintSetup) == 0x00E0);
static_assert(offsetof(FAnimNode_Constraint, ConstraintWeights) == 0x00F0);
static_assert(offsetof(FAnimNode_CopyBone, SourceBone) == 0x00D0);
static_assert(offsetof(FAnimNode_CopyBone, TargetBone) == 0x00E0);
static_assert(offsetof(FAnimNode_CopyBone, ControlSpace) == 0x00F3);
static_assert(offsetof(FAnimNode_CopyBoneDelta, SourceBone) == 0x00D0);
static_assert(offsetof(FAnimNode_CopyBoneDelta, TargetBone) == 0x00E0);
static_assert(offsetof(FAnimNode_CopyBoneDelta, CopyMode) == 0x00F3);
...
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandFK) == 0x00D0);
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandFK) == 0x00E0);
static_assert(offsetof(FAnimNode_HandIKRetargeting, RightHandIK) == 0x00F0);
static_assert(offsetof(FAnimNode_HandIKRetargeting, LeftHandIK) == 0x0100);
static_assert(offsetof(FAnimNode_HandIKRetargeting, IKBonesToMove) == 0x0110);
...
static_assert(offsetof(FAnimNode_LegIK, LegsDefinition) == 0x00D8);
static_assert(offsetof(FAnimNode_LookAt, BoneToModify) == 0x00D0);
...
static_assert(offsetof(FAnimNode_ModifyBone, BoneToModify) == 0x00D0);
static_assert(offsetof(FAnimNode_ModifyBone, Translation) == 0x00E0);
static_assert(offsetof(FAnimNode_ModifyBone, Rotation) == 0x00EC);
static_assert(offsetof(FAnimNode_ModifyBone, Scale) == 0x00F8);
static_assert(offsetof(FAnimNode_ModifyBone, TranslationMode) == 0x0104);
static_assert(offsetof(FAnimNode_ModifyBone, RotationMode) == 0x0105);
static_assert(offsetof(FAnimNode_ModifyBone, ScaleMode) == 0x0106);
static_assert(offsetof(FAnimNode_ModifyBone, TranslationSpace) == 0x0107);
static_assert(offsetof(FAnimNode_ModifyBone, RotationSpace) == 0x0108);
static_assert(offsetof(FAnimNode_ModifyBone, ScaleSpace) == 0x0109);
static_assert(offsetof(FAnimNode_ModifyBone, ActualTranslation) == 0x010C);
static_assert(offsetof(FAnimNode_ModifyBone, ActualRotation) == 0x0118);
static_assert(offsetof(FAnimNode_ModifyBone, TranslationInterp) == 0x0124);
static_assert(offsetof(FAnimNode_ModifyBone, RotationInterp) == 0x013C);
...
static_assert(offsetof(FAnimNode_ModifyCurve, AlphaScaleBiasClamp) == 0x005C);
...
static_assert(offsetof(FAnimNode_ObserveBone, BoneToObserve) == 0x00D0);
static_assert(offsetof(FAnimNode_ObserveBone, DisplaySpace) == 0x00E0);
static_assert(offsetof(FAnimNode_ObserveBone, Translation) == 0x00E4);
static_assert(offsetof(FAnimNode_ObserveBone, Rotation) == 0x00F0);
static_assert(offsetof(FAnimNode_ObserveBone, Scale) == 0x00FC);
static_assert(offsetof(FAnimNode_PoseHandler, PoseAsset) == 0x0120);
static_assert(offsetof(FAnimNode_PoseBlendNode, SourcePose) == 0x0168);
static_assert(offsetof(FAnimNode_PoseBlendNode, BlendOption) == 0x0178);
static_assert(offsetof(FAnimNode_PoseBlendNode, CustomCurve) == 0x0180);
static_assert(offsetof(FAnimNode_PoseByName, PoseName) == 0x0168);
...
static_assert(offsetof(FAnimNode_PoseDriver, SourcePose) == 0x0168);
static_assert(offsetof(FAnimNode_PoseDriver, SourceBones) == 0x0178);
static_assert(offsetof(FAnimNode_PoseDriver, OnlyDriveBones) == 0x0188);
static_assert(offsetof(FAnimNode_PoseDriver, PoseTargets) == 0x0198);
static_assert(offsetof(FAnimNode_PoseDriver, EvalSpaceBone) == 0x01D8);
static_assert(offsetof(FAnimNode_PoseDriver, RBFParams) == 0x01E8);
static_assert(offsetof(FAnimNode_PoseDriver, DriveSource) == 0x0214);
static_assert(offsetof(FAnimNode_PoseDriver, DriveOutput) == 0x0215);
...
static_assert(offsetof(FRefPoseLimit, TargetBone) == 0x0000);
static_assert(offsetof(FRefPoseLimit, TranslationLimitMin) == 0x0014);
static_assert(offsetof(FRefPoseLimit, TranslationLimitMax) == 0x0020);
static_assert(offsetof(FRefPoseLimit, RotationLimitMin) == 0x0030);
static_assert(offsetof(FRefPoseLimit, RotationLimitMax) == 0x003C);
static_assert(offsetof(FAnimNode_RigidBody, OverridePhysicsAsset) == 0x00D8);
static_assert(offsetof(FAnimNode_RigidBody, OverrideWorldGravity) == 0x0178);
static_assert(offsetof(FAnimNode_RigidBody, ExternalForce) == 0x0184);
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearAccScale) == 0x0190);
static_assert(offsetof(FAnimNode_RigidBody, ComponentLinearVelScale) == 0x019C);
static_assert(offsetof(FAnimNode_RigidBody, ComponentAppliedLinearAccClamp) == 0x01A8);
static_assert(offsetof(FAnimNode_RigidBody, SimSpaceSettings) == 0x01B4);
static_assert(offsetof(FAnimNode_RigidBody, BaseBoneRef) == 0x01F8);
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x0208);
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x0209);
static_assert(offsetof(FAnimNode_RigidBody, ExternalCollisionBone) == 0x021C);
static_assert(offsetof(FAnimNode_RigidBody, ExternalCollisionTarget) == 0x0230);
static_assert(offsetof(FAnimNode_RigidBody, ExternalCollisionTargetCached) == 0x0238);
static_assert(offsetof(FAnimNode_RigidBody, RefPoseLimits) == 0x0298);
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceCorrection_Roll) == 0x02AC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_X) == 0x02BC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_Y) == 0x02CC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_Z) == 0x02DC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_Pitch) == 0x02EC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_Yaw) == 0x02FC);
static_assert(offsetof(FAnimNode_RigidBody, LocalSpaceCorrection_Roll) == 0x030C);
static_assert(offsetof(FAnimNode_RigidBody, MaxLinearVelocity_Simulation) == 0x0320);
static_assert(offsetof(FAnimNode_RigidBody, MaxAngularVelocity_Simulation) == 0x0330);
...
static_assert(offsetof(FAnimNode_RotationMultiplier, TargetBone) == 0x00D0);
static_assert(offsetof(FAnimNode_RotationMultiplier, SourceBone) == 0x00E0);
static_assert(offsetof(FAnimNode_RotationMultiplier, RotationAxisToRefer) == 0x00F4);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, BasePose) == 0x0208);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBias) == 0x0220);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaBoolBlend) == 0x0228);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaCurveName) == 0x0270);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaScaleBiasClamp) == 0x0278);
static_assert(offsetof(FAnimNode_RotationOffsetBlendSpace, AlphaInputType) == 0x02AC);
...
static_assert(offsetof(FAnimNode_SequenceEvaluator, Sequence) == 0x0120);
static_assert(offsetof(FAnimNode_SequenceEvaluator, ReinitializationBehavior) == 0x012E);
static_assert(offsetof(FAnimNode_SequenceEvaluator, LastPlayAnimSeq) == 0x0138);
static_assert(offsetof(FAnimNode_Slot, Source) == 0x0010);
static_assert(offsetof(FAnimNode_Slot, SlotName) == 0x0020);
static_assert(offsetof(FAnimNode_SplineIK, StartBone) == 0x00D0);
static_assert(offsetof(FAnimNode_SplineIK, EndBone) == 0x00E0);
static_assert(offsetof(FAnimNode_SplineIK, BoneAxis) == 0x00F0);
static_assert(offsetof(FAnimNode_SplineIK, ControlPoints) == 0x00F8);
static_assert(offsetof(FAnimNode_SplineIK, TwistBlend) == 0x0118);
static_assert(offsetof(FSplineIKCachedBoneData, Bone) == 0x0000);
static_assert(offsetof(FAnimNode_SpringBone, SpringBone) == 0x00D0);
...
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, BaseFrame) == 0x00D0);
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistFrame) == 0x00F0);
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, TwistPlaneNormalAxis) == 0x0110);
static_assert(offsetof(FAnimNode_TwistCorrectiveNode, Curve) == 0x012C);
static_assert(offsetof(FAnimNode_TwoBoneIK, IKBone) == 0x00D0);
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocation) == 0x00E8);
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorTarget) == 0x0100);
...
static_assert(offsetof(FAnimNode_TwoBoneIK, TwistAxis) == 0x01D0);
static_assert(offsetof(FAnimNode_TwoBoneIK, EffectorLocationSpace) == 0x01E0);
static_assert(offsetof(FAnimNode_TwoBoneIK, JointTargetLocationSpace) == 0x01E1);
