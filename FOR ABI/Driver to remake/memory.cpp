...
/* Initialize win32kbase.sys hook */
NTSTATUS InitializeWin32kHook()
{
    DBG_COMM("0x401\\n"); // Initializing win32kbase.sys hook
    ...
    DBG_COMM("0x403\\n"); // win32kbase.sys hook initialized
    return STATUS_SUCCESS;
}
...
{
    DBG_COMM("0x501\\n"); // Initializing NTFS storage driver
    ...
    DBG_COMM("0x504\\n"); // NTFS storage driver initialized
    return STATUS_SUCCESS;
}
