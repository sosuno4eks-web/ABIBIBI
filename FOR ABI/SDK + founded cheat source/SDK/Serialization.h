...
{ 
	...
	SDK_UNDEFINED(40,2783) /* TWeakObjectPtr<UClass*> */ __um(SoftClass);                                          // 0x0010   (0x0028)  
	class UObject*                                     Object;                                                     // 0x0038   (0x0008)  
	SDK_UNDEFINED(8,2784) /* TWeakObjectPtr<UMetaData*> */ __um(WeakObject);                                       // 0x0040   (0x0008)  
	SDK_UNDEFINED(40,2785) /* TWeakObjectPtr<UMetaData*> */ __um(SoftObject);                                      // 0x0048   (0x0028)  
...
{ 
	SDK_UNDEFINED(80,2786) /* TMap<int32_t, FString> */ __um(IntToStr);                                            // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,2787) /* TMap<FString, FString> */ __um(StrToStr);                                            // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,2788) /* TMap<FString, FVector> */ __um(StrToVec);                                            // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,2789) /* TMap<FString, FStructSerializerBuiltinTestStruct> */ __um(StrToStruct);              // 0x00F0   (0x0050)  
};
...
{ 
	SDK_UNDEFINED(80,2790) /* TSet<FString> */         __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,2791) /* TSet<int32_t> */         __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,2792) /* TSet<FName> */           __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,2793) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                         // 0x00F0   (0x0050)  
};
