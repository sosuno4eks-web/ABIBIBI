...
/// Size: 0x0110 (272 bytes) (0x0000C0 - 0x0001D0) align 8 pad: 0x0000
...
public:
	...
	FBrushStampData                                    LastBrushStamp;                                             // 0x00D0   (0x00C0)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x0190   (0x0010)  MISSED
	SDK_UNDEFINED(40,2687) /* TWeakObjectPtr<UClass*> */ __um(PropertyClass);                                      // 0x01A0   (0x0028)  
...
public:
	...
	SDK_UNDEFINED(16,2688) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2689) /* TScriptInterface<Class> */ __um(AngleSource);                                        // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2690) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2691) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,2692) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2693) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2694) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2695) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
...
/// Size: 0x0028 (40 bytes) (0x0005D8 - 0x000600) align 16 pad: 0x0008
#pragma pack(push, 0x1)
class UGizmoBaseComponent : public UPrimitiveComponent
{ 
public:
	FLinearColor                                       Color;                                                      // 0x05D8   (0x0010)  
	float                                              HoverSizeMultiplier;                                        // 0x05E8   (0x0004)  
	float                                              PixelHitDistanceThreshold;                                  // 0x05EC   (0x0004)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x05F0   (0x0008)  MISSED


	/// Functions
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x5d61010] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x5d60f80] Final|Native|Public  
};
#pragma pack(pop)

/// Class /Script/InteractiveToolsFramework.GizmoArrowComponent
/// Size: 0x0028 (40 bytes) (0x0005F8 - 0x000620) align 16 pad: 0x0000
class UGizmoArrowComponent : public UGizmoBaseComponent
{ 
public:
	FVector                                            Direction;                                                  // 0x05F8   (0x000C)  
	float                                              Gap;                                                        // 0x0604   (0x0004)  
	float                                              Length;                                                     // 0x0608   (0x0004)  
	float                                              Thickness;                                                  // 0x060C   (0x0004)  
	unsigned char                                      UnknownData00_7[0x10];                                      // 0x0610   (0x0010)  MISSED
};

/// Class /Script/InteractiveToolsFramework.GizmoBoxComponent
/// Size: 0x0048 (72 bytes) (0x0005F8 - 0x000640) align 16 pad: 0x0000
class UGizmoBoxComponent : public UGizmoBaseComponent
{ 
public:
	FVector                                            Origin;                                                     // 0x05F8   (0x000C)  
	unsigned char                                      UnknownData00_6[0xC];                                       // 0x0604   (0x000C)  MISSED
	FQuat                                              Rotation;                                                   // 0x0610   (0x0010)  
	FVector                                            Dimensions;                                                 // 0x0620   (0x000C)  
	float                                              LineThickness;                                              // 0x062C   (0x0004)  
	bool                                               bRemoveHiddenLines;                                         // 0x0630   (0x0001)  
	bool                                               bEnableAxisFlip;                                            // 0x0631   (0x0001)  
	unsigned char                                      UnknownData01_7[0xE];                                       // 0x0632   (0x000E)  MISSED
};
...
{ 
public:
	FVector                                            Normal;                                                     // 0x05F8   (0x000C)  
	float                                              Radius;                                                     // 0x0604   (0x0004)  
	float                                              Thickness;                                                  // 0x0608   (0x0004)  
	int32_t                                            NumSides;                                                   // 0x060C   (0x0004)  
	bool                                               bViewAligned;                                               // 0x0610   (0x0001)  
	bool                                               bOnlyAllowFrontFacingHits;                                  // 0x0611   (0x0001)  
	unsigned char                                      UnknownData00_7[0xE];                                       // 0x0612   (0x000E)  MISSED
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x5d60e10] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x5d60d10] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x288c780] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x5d60c20] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x2a20d00] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x2dad720] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x5d60ef0] Native|Public|Const  
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x2a20fb0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x2a7ed80] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x5d60d80] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x5d60be0] Native|Public|HasDefaults|Const 
...
public:
	FVector                                            Normal;                                                     // 0x05F8   (0x000C)  
	float                                              HandleSize;                                                 // 0x0604   (0x0004)  
	float                                              Thickness;                                                  // 0x0608   (0x0004)  
	FVector                                            Direction;                                                  // 0x060C   (0x000C)  
	float                                              Length;                                                     // 0x0618   (0x0004)  
	bool                                               bImageScale;                                                // 0x061C   (0x0001)  
	unsigned char                                      UnknownData00_7[0x3];                                       // 0x061D   (0x0003)  MISSED
};

/// Class /Script/InteractiveToolsFramework.GizmoRectangleComponent
/// Size: 0x0038 (56 bytes) (0x0005F8 - 0x000630) align 16 pad: 0x0000
class UGizmoRectangleComponent : public UGizmoBaseComponent
{ 
public:
	FVector                                            DirectionX;                                                 // 0x05F8   (0x000C)  
	FVector                                            DirectionY;                                                 // 0x0604   (0x000C)  
	float                                              offsetX;                                                    // 0x0610   (0x0004)  
	float                                              OffsetY;                                                    // 0x0614   (0x0004)  
	float                                              LengthX;                                                    // 0x0618   (0x0004)  
	float                                              LengthY;                                                    // 0x061C   (0x0004)  
	float                                              Thickness;                                                  // 0x0620   (0x0004)  
	char                                               SegmentFlags;                                               // 0x0624   (0x0001)  
	unsigned char                                      UnknownData00_7[0xB];                                       // 0x0625   (0x000B)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(80,2696) /* TMap<FString, UInteractiveGizmoBuilder*> */ __um(GizmoBuilders);                     // 0x0058   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,2697) /* TMap<FString, UInteractiveToolBuilder*> */ __um(ToolBuilders);                       // 0x0090   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(40,2698) /* TWeakObjectPtr<UClass*> */ __um(ToolManagerClass);                                   // 0x0070   (0x0028)  
};
...
{ 
public:
	class UGizmoLineHandleComponent*                   UpIntervalComponent;                                        // 0x02E0   (0x0008)  
	class UGizmoLineHandleComponent*                   DownIntervalComponent;                                      // 0x02E8   (0x0008)  
	class UGizmoLineHandleComponent*                   ForwardIntervalComponent;                                   // 0x02F0   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,2699) /* TScriptInterface<Class> */ __um(FloatParameterSource);                               // 0x0048   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,2700) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2701) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,2702) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2703) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,2704) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2705) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,2706) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2707) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,2708) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2709) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_3[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,2710) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,2711) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_3[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,2712) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,2713) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,2714) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,2715) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
	bool                                               bEnableSignedAxis;                                          // 0x0088   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,2716) /* TScriptInterface<Class> */ __um(TransactionManager);                                 // 0x0050   (0x0010)  
...
{ 
public:
	class UPrimitiveComponent*                         TranslateX;                                                 // 0x02E0   (0x0008)  
	class UPrimitiveComponent*                         TranslateY;                                                 // 0x02E8   (0x0008)  
	class UPrimitiveComponent*                         TranslateZ;                                                 // 0x02F0   (0x0008)  
	class UPrimitiveComponent*                         TranslateYZ;                                                // 0x02F8   (0x0008)  
	class UPrimitiveComponent*                         TranslateXZ;                                                // 0x0300   (0x0008)  
	class UPrimitiveComponent*                         TranslateXY;                                                // 0x0308   (0x0008)  
	class UPrimitiveComponent*                         RotateX;                                                    // 0x0310   (0x0008)  
	class UPrimitiveComponent*                         RotateY;                                                    // 0x0318   (0x0008)  
	class UPrimitiveComponent*                         RotateZ;                                                    // 0x0320   (0x0008)  
	class UPrimitiveComponent*                         UniformScale;                                               // 0x0328   (0x0008)  
	class UPrimitiveComponent*                         AxisScaleX;                                                 // 0x0330   (0x0008)  
	class UPrimitiveComponent*                         AxisScaleY;                                                 // 0x0338   (0x0008)  
	class UPrimitiveComponent*                         AxisScaleZ;                                                 // 0x0340   (0x0008)  
	class UPrimitiveComponent*                         PlaneScaleYZ;                                               // 0x0348   (0x0008)  
	class UPrimitiveComponent*                         PlaneScaleXZ;                                               // 0x0350   (0x0008)  
	class UPrimitiveComponent*                         PlaneScaleXY;                                               // 0x0358   (0x0008)  
};
...
{ 
public:
	SDK_UNDEFINED(16,2717) /* TScriptInterface<Class> */ __um(ChildTransformSource);                               // 0x0048   (0x0010)  
...
static_assert(sizeof(AInternalToolFrameworkActor) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
...
static_assert(sizeof(FBrushStampData) == 0x00C0); // 192 bytes (0x000000 - 0x0000C0)
static_assert(sizeof(UBaseBrushTool) == 0x01D0); // 464 bytes (0x0000C0 - 0x0001D0)
...
static_assert(sizeof(AGizmoActor) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UGizmoBaseComponent) == 0x05F8); // 1528 bytes (0x0005D8 - 0x0005F8)
static_assert(sizeof(UGizmoArrowComponent) == 0x0620); // 1568 bytes (0x0005F8 - 0x000620)
static_assert(sizeof(UGizmoBoxComponent) == 0x0640); // 1600 bytes (0x0005F8 - 0x000640)
static_assert(sizeof(UGizmoCircleComponent) == 0x0620); // 1568 bytes (0x0005F8 - 0x000620)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x0620); // 1568 bytes (0x0005F8 - 0x000620)
static_assert(sizeof(UGizmoRectangleComponent) == 0x0630); // 1584 bytes (0x0005F8 - 0x000630)
...
static_assert(sizeof(AIntervalGizmoActor) == 0x02F8); // 760 bytes (0x0002E0 - 0x0002F8)
...
static_assert(sizeof(ATransformGizmoActor) == 0x0360); // 864 bytes (0x0002E0 - 0x000360)
...
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x01C8);
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x05D8);
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x05F8);
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x05F8);
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x0610);
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x0620);
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x05F8);
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x05F8);
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x060C);
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x05F8);
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x0604);
...
static_assert(offsetof(AIntervalGizmoActor, UpIntervalComponent) == 0x02E0);
static_assert(offsetof(AIntervalGizmoActor, DownIntervalComponent) == 0x02E8);
static_assert(offsetof(AIntervalGizmoActor, ForwardIntervalComponent) == 0x02F0);
...
static_assert(offsetof(ATransformGizmoActor, TranslateX) == 0x02E0);
static_assert(offsetof(ATransformGizmoActor, TranslateY) == 0x02E8);
static_assert(offsetof(ATransformGizmoActor, TranslateZ) == 0x02F0);
static_assert(offsetof(ATransformGizmoActor, TranslateYZ) == 0x02F8);
static_assert(offsetof(ATransformGizmoActor, TranslateXZ) == 0x0300);
static_assert(offsetof(ATransformGizmoActor, TranslateXY) == 0x0308);
static_assert(offsetof(ATransformGizmoActor, RotateX) == 0x0310);
static_assert(offsetof(ATransformGizmoActor, RotateY) == 0x0318);
static_assert(offsetof(ATransformGizmoActor, RotateZ) == 0x0320);
static_assert(offsetof(ATransformGizmoActor, UniformScale) == 0x0328);
static_assert(offsetof(ATransformGizmoActor, AxisScaleX) == 0x0330);
static_assert(offsetof(ATransformGizmoActor, AxisScaleY) == 0x0338);
static_assert(offsetof(ATransformGizmoActor, AxisScaleZ) == 0x0340);
static_assert(offsetof(ATransformGizmoActor, PlaneScaleYZ) == 0x0348);
static_assert(offsetof(ATransformGizmoActor, PlaneScaleXZ) == 0x0350);
static_assert(offsetof(ATransformGizmoActor, PlaneScaleXY) == 0x0358);
