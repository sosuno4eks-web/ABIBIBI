...
/// Size: 0x0050 (80 bytes) (0x000610 - 0x000660) align 16 pad: 0x0008
#pragma pack(push, 0x1)
class UBaseDynamicMeshComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_1[0x48];                                      // 0x0610   (0x0048)  MISSED
};
#pragma pack(pop)
...
{ 
public:
	class UMaterialInterface*                          LineMaterial;                                               // 0x0610   (0x0008)  
	FBoxSphereBounds                                   Bounds;                                                     // 0x0618   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x0634   (0x0001)  
	unsigned char                                      UnknownData00_7[0x3B];                                      // 0x0635   (0x003B)  MISSED
};
...
/// Size: 0x0118 (280 bytes) (0x000658 - 0x000770) align 16 pad: 0x0000
class UOctreeDynamicMeshComponent : public UBaseDynamicMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x18];                                      // 0x0658   (0x0018)  MISSED
	bool                                               bExplicitShowWireframe;                                     // 0x0670   (0x0001)  
	unsigned char                                      UnknownData01_7[0xFF];                                      // 0x0671   (0x00FF)  MISSED
};

/// Class /Script/ModelingComponents.PlaneDistanceFromHitMechanic
/// Size: 0x0480 (1152 bytes) (0x000030 - 0x0004B0) align 16 pad: 0x0000
class UPlaneDistanceFromHitMechanic : public UInteractionMechanic
{ 
public:
	unsigned char                                      UnknownData00_1[0x480];                                     // 0x0030   (0x0480)  MISSED
};
...
{ 
public:
	class UMaterialInterface*                          PointMaterial;                                              // 0x0610   (0x0008)  
	FBoxSphereBounds                                   Bounds;                                                     // 0x0618   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x0634   (0x0001)  
	unsigned char                                      UnknownData00_7[0x3B];                                      // 0x0635   (0x003B)  MISSED
};
...
public:
	...
	bool                                               bPreferProjectedElement;                                    // 0x0063   (0x0001)  
	bool                                               bSelectDownRay;                                             // 0x0064   (0x0001)  
	bool                                               bIgnoreOcclusion;                                           // 0x0065   (0x0001)  
...
public:
	...
	unsigned char                                      UnknownData01_6[0x308];                                     // 0x0058   (0x0308)  MISSED
	class APreviewGeometryActor*                       PreviewGeometryActor;                                       // 0x0360   (0x0008)  
	class UTriangleSetComponent*                       DrawnTriangleSetComponent;                                  // 0x0368   (0x0008)  
	unsigned char                                      UnknownData02_6[0x50];                                      // 0x0370   (0x0050)  MISSED
	class UMaterialInterface*                          HighlightedFaceMaterial;                                    // 0x03C0   (0x0008)  
	unsigned char                                      UnknownData03_7[0x2A8];                                     // 0x03C8   (0x02A8)  MISSED
};
...
public:
	...
	SDK_UNDEFINED(80,2751) /* TMap<FString, ULineSetComponent*> */ __um(LineSets);                                 // 0x0030   (0x0050)  


	/// Functions
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetVisibility
	// bool SetLineSetVisibility(FString LineSetIdentifier, bool bVisible);                                                     // [0x1426c70] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetMaterial
	// bool SetLineSetMaterial(FString LineSetIdentifier, class UMaterialInterface* NewMaterial);                               // [0x1426b80] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial
	// void SetAllLineSetsMaterial(class UMaterialInterface* Material);                                                         // [0x1426af0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveLineSet
	// bool RemoveLineSet(FString LineSetIdentifier, bool bDestroy);                                                            // [0x1426a00] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllLineSets
	// void RemoveAllLineSets(bool bDestroy);                                                                                   // [0x1426970] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.GetActor
	// class APreviewGeometryActor* GetActor();                                                                                 // [0x1426870] Final|Native|Public|Const 
	// Function /Script/ModelingComponents.PreviewGeometry.FindLineSet
	// class ULineSetComponent* FindLineSet(FString LineSetIdentifier);                                                         // [0x14267c0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.Disconnect
	// void Disconnect();                                                                                                       // [0x14267a0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.CreateInWorld
	// void CreateInWorld(class UWorld* World, FTransform& WithTransform);                                                      // [0x1426680] Final|Native|Public|HasOutParms|HasDefaults 
	// Function /Script/ModelingComponents.PreviewGeometry.AddLineSet
	// class ULineSetComponent* AddLineSet(FString LineSetIdentifier);                                                          // [0x14265d0] Final|Native|Public  
};
...
/// Size: 0x0158 (344 bytes) (0x000658 - 0x0007B0) align 16 pad: 0x0000
class USimpleDynamicMeshComponent : public UBaseDynamicMeshComponent
{ 
public:
	EDynamicMeshTangentCalcType                        TangentsType;                                               // 0x0658   (0x0001)  
	bool                                               bInvalidateProxyOnChange;                                   // 0x0659   (0x0001)  
	unsigned char                                      UnknownData00_6[0x36];                                      // 0x065A   (0x0036)  MISSED
	bool                                               bExplicitShowWireframe;                                     // 0x0690   (0x0001)  
	unsigned char                                      UnknownData01_6[0x4F];                                      // 0x0691   (0x004F)  MISSED
	bool                                               bDrawOnTop;                                                 // 0x06E0   (0x0001)  
	unsigned char                                      UnknownData02_7[0xCF];                                      // 0x06E1   (0x00CF)  MISSED
};
...
/// Size: 0x00E0 (224 bytes) (0x000610 - 0x0006F0) align 16 pad: 0x0000
class UTriangleSetComponent : public UMeshComponent
{ 
public:
	FBoxSphereBounds                                   Bounds;                                                     // 0x0610   (0x001C)  
	bool                                               bBoundsDirty;                                               // 0x062C   (0x0001)  
	unsigned char                                      UnknownData00_7[0xC3];                                      // 0x062D   (0x00C3)  MISSED
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0x1426890] Final|Native|Public  
};
...
static_assert(sizeof(UBaseDynamicMeshComponent) == 0x0658); // 1624 bytes (0x000610 - 0x000658)
...
static_assert(sizeof(ULineSetComponent) == 0x0670); // 1648 bytes (0x000610 - 0x000670)
...
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x0770); // 1904 bytes (0x000658 - 0x000770)
static_assert(sizeof(UPlaneDistanceFromHitMechanic) == 0x04B0); // 1200 bytes (0x000030 - 0x0004B0)
static_assert(sizeof(UPointSetComponent) == 0x0670); // 1648 bytes (0x000610 - 0x000670)
...
static_assert(sizeof(UPolygonSelectionMechanic) == 0x0670); // 1648 bytes (0x000030 - 0x000670)
static_assert(sizeof(APreviewGeometryActor) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UPreviewGeometry) == 0x0080); // 128 bytes (0x000028 - 0x000080)
static_assert(sizeof(APreviewMeshActor) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(USimpleDynamicMeshComponent) == 0x07B0); // 1968 bytes (0x000658 - 0x0007B0)
...
static_assert(sizeof(UTriangleSetComponent) == 0x06F0); // 1776 bytes (0x000610 - 0x0006F0)
...
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x0610);
static_assert(offsetof(ULineSetComponent, Bounds) == 0x0618);
...
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x0610);
static_assert(offsetof(UPointSetComponent, Bounds) == 0x0618);
...
static_assert(offsetof(UPolygonSelectionMechanic, PreviewGeometryActor) == 0x0360);
static_assert(offsetof(UPolygonSelectionMechanic, DrawnTriangleSetComponent) == 0x0368);
static_assert(offsetof(UPolygonSelectionMechanic, HighlightedFaceMaterial) == 0x03C0);
static_assert(offsetof(UPreviewGeometry, ParentActor) == 0x0028);
static_assert(offsetof(USimpleDynamicMeshComponent, TangentsType) == 0x0658);
...
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x0610);
