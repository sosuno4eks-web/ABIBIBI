...
public:
	...
	// void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive);                                                          // [0x3a75280] Event|Public|BlueprintEvent 
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	// void OnMatchEnded(FString Match);                                                                                        // [0x3a75280] Event|Public|BlueprintEvent 
};
