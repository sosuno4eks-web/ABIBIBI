...
/// Size: 0x00C0 (192 bytes) (0x0006F0 - 0x0007B0) align 16 pad: 0x0000
class USynthComponentMoto : public USynthComponent
{ 
public:
	class UMotoSynthPreset*                            MotoSynthPreset;                                            // 0x06F0   (0x0008)  
	float                                              RPM;                                                        // 0x06F8   (0x0004)  
	unsigned char                                      UnknownData00_7[0xB4];                                      // 0x06FC   (0x00B4)  MISSED


	/// Functions
	// Function /Script/MotoSynth.SynthComponentMoto.SetSettings
	// void SetSettings(FMotoSynthRuntimeSettings& InSettings);                                                                 // [0x3066d80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.SetRPM
	// void SetRPM(float InRPM, float InTimeSec);                                                                               // [0x3066cb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotoSynth.SynthComponentMoto.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x3066c80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MotoSynth.SynthComponentMoto.GetRPMRange
	// void GetRPMRange(float& OutMinRPM, float& OutMaxRPM);                                                                    // [0x3066ba0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
static_assert(sizeof(USynthComponentMoto) == 0x07B0); // 1968 bytes (0x0006F0 - 0x0007B0)
...
static_assert(offsetof(USynthComponentMoto, MotoSynthPreset) == 0x06F0);
