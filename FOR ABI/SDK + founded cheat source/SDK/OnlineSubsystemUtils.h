...
/// Size: 0x0070 (112 bytes) (0x000898 - 0x000908) align 8 pad: 0x0000
class UIpNetDriver : public UNetDriver
{ 
public:
	bool                                               LogPortUnreach : 1;                                         // 0x0898:0 (0x0001)  
	bool                                               AllowPlayerPortUnreach : 1;                                 // 0x0898:1 (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0899   (0x0003)  MISSED
	uint32_t                                           MaxPortCountToTry;                                          // 0x089C   (0x0004)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x08A0   (0x000C)  MISSED
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                      // 0x08AC   (0x0004)  
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                         // 0x08B0   (0x0004)  
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                      // 0x08B4   (0x0004)  
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                         // 0x08B8   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x08BC   (0x0004)  MISSED
	double                                             MaxSecondsInReceive;                                        // 0x08C0   (0x0008)  
	int32_t                                            NbPacketsBetweenReceiveTimeTest;                            // 0x08C8   (0x0004)  
	float                                              ResolutionConnectionTimeout;                                // 0x08CC   (0x0004)  
	unsigned char                                      UnknownData03_7[0x38];                                      // 0x08D0   (0x0038)  MISSED
};

/// Class /Script/OnlineSubsystemUtils.IpConnection
/// Size: 0x00A0 (160 bytes) (0x001B78 - 0x001C18) align 8 pad: 0x0000
class UIpConnection : public UNetConnection
{ 
public:
	unsigned char                                      UnknownData00_3[0x50];                                      // 0x1B78   (0x0050)  MISSED
	float                                              SocketErrorDisconnectDelay;                                 // 0x1BC8   (0x0004)  
	unsigned char                                      UnknownData01_7[0x4C];                                      // 0x1BCC   (0x004C)  MISSED
};
...
public:
	...
	// void GetCachedAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, float& Progress); // [0x2f05c00] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementBlueprintLibrary.GetCachedAchievementDescription
	// void GetCachedAchievementDescription(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, FText& Title, FText& LockedDescription, FText& UnlockedDescription, bool& bHidden); // [0x2f058a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,655) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,656) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// class UAchievementQueryCallbackProxy* CacheAchievements(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x2f04610] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievementDescriptions
	// class UAchievementQueryCallbackProxy* CacheAchievementDescriptions(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x2f04540] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UAchievementWriteCallbackProxy* WriteAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementName, float Progress, int32_t UserTag); // [0x2f06670] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,659) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,660) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// class UConnectionCallbackProxy* ConnectToService(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x2f046e0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,661) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,662) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// class UCreateSessionCallbackProxy* CreateSession(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t PublicConnections, bool bUseLAN); // [0x2f04f10] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UDestroySessionCallbackProxy* DestroySession(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x2f05060] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UEndTurnCallbackProxy* EndTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TScriptInterface<Class> TurnBasedMatchInterface); // [0x2f05360] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,669) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,670) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// FString GetServerName(FBlueprintSessionResult& Result);                                                                  // [0x2f06410] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetPingInMs
	// int32_t GetPingInMs(FBlueprintSessionResult& Result);                                                                    // [0x2f061f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetMaxPlayers
	// int32_t GetMaxPlayers(FBlueprintSessionResult& Result);                                                                  // [0x2f05fd0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetCurrentPlayers
	// int32_t GetCurrentPlayers(FBlueprintSessionResult& Result);                                                              // [0x2f05db0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.FindSessions
	// class UFindSessionsCallbackProxy* FindSessions(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t MaxResults, bool bUseLAN); // [0x2f05520] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,671) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,672) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,673) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,674) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseCallbackProxy* CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController, FInAppPurchaseProductRequest& ProductRequest); // [0x2f048a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,675) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,676) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseUnprocessedPurchases(class APlayerController* PlayerController); // [0x2f04e80] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchaseQueryOwned
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseQueryOwned(class APlayerController* PlayerController); // [0x2f04bb0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchase
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0x2f047b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,677) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,678) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseQueryCallbackProxy* CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0x2f04aa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,679) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,680) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseQueryCallbackProxy2* CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0x2f04990] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,681) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,682) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	unsigned char                                      UnknownData00_7[0x48];                                      // 0x0048   (0x0048)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy.CreateProxyObjectForInAppPurchaseRestore
	// class UInAppPurchaseRestoreCallbackProxy* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest>& ConsumableProductFlags, class APlayerController* PlayerController); // [0x2f04d60] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,683) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,684) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	unsigned char                                      UnknownData00_7[0x60];                                      // 0x0048   (0x0060)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseRestoreCallbackProxy2.CreateProxyObjectForInAppPurchaseRestore
	// class UInAppPurchaseRestoreCallbackProxy2* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest2>& ConsumableProductFlags, class APlayerController* PlayerController); // [0x2f04c40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,685) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,686) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// class UJoinSessionCallbackProxy* JoinSession(class UObject* WorldContextObject, class APlayerController* PlayerController, FBlueprintSessionResult& SearchResult); // [0x2f0a2d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool WriteLeaderboardInteger(class APlayerController* PlayerController, FName StatName, int32_t StatValue);              // [0x2f0b2a0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,687) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,688) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	unsigned char                                      UnknownData00_7[0x20];                                      // 0x0048   (0x0020)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.LeaderboardFlushCallbackProxy.CreateProxyObjectForFlush
	// class ULeaderboardFlushCallbackProxy* CreateProxyObjectForFlush(class APlayerController* PlayerController, FName SessionName); // [0x2f0a130] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,689) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,690) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0038   (0x0010)  
	...
	// class ULeaderboardQueryCallbackProxy* CreateProxyObjectForIntQuery(class APlayerController* PlayerController, FName StatName); // [0x2f0a200] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,691) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,692) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	unsigned char                                      UnknownData00_7[0x18];                                      // 0x0050   (0x0018)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.LogoutCallbackProxy.Logout
	// class ULogoutCallbackProxy* Logout(class UObject* WorldContextObject, class APlayerController* PlayerController);        // [0x2f0a420] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                             // 0x02E8   (0x0004)  
	float                                              BeaconConnectionTimeout;                                    // 0x02EC   (0x0004)  
	class UNetDriver*                                  NetDriver;                                                  // 0x02F0   (0x0008)  
	unsigned char                                      UnknownData01_7[0x18];                                      // 0x02F8   (0x0018)  MISSED
};

/// Class /Script/OnlineSubsystemUtils.OnlineBeaconClient
/// Size: 0x0060 (96 bytes) (0x000310 - 0x000370) align 8 pad: 0x0000
class AOnlineBeaconClient : public AOnlineBeacon
{ 
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                                // 0x0310   (0x0008)  
	class UNetConnection*                              BeaconConnection;                                           // 0x0318   (0x0008)  
	EBeaconConnectionState                             ConnectionState;                                            // 0x0320   (0x0001)  
	unsigned char                                      UnknownData00_7[0x4F];                                      // 0x0321   (0x004F)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.OnlineBeaconClient.ClientOnConnected
	// void ClientOnConnected();                                                                                                // [0xc31a20] Final|Net|NetReliableNative|Event|Private|NetClient 
};

/// Class /Script/OnlineSubsystemUtils.OnlineBeaconHost
/// Size: 0x00B8 (184 bytes) (0x000310 - 0x0003C8) align 8 pad: 0x0000
class AOnlineBeaconHost : public AOnlineBeacon
{ 
public:
	int32_t                                            ListenPort;                                                 // 0x0310   (0x0004)  
	unsigned char                                      UnknownData00_6[0x4];                                       // 0x0314   (0x0004)  MISSED
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                               // 0x0318   (0x0010)  
	unsigned char                                      UnknownData01_7[0xA0];                                      // 0x0328   (0x00A0)  MISSED
};
...
{ 
public:
	FString                                            BeaconTypeName;                                             // 0x02E0   (0x0010)  
	class UClass*                                      ClientBeaconActorClass;                                     // 0x02F0   (0x0008)  
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                               // 0x02F8   (0x0010)  
};
...
/// Size: 0x01B8 (440 bytes) (0x000028 - 0x0001E0) align 8 pad: 0x0000
...
/// Size: 0x00C0 (192 bytes) (0x000370 - 0x000430) align 8 pad: 0x0000
class APartyBeaconClient : public AOnlineBeaconClient
{ 
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0370   (0x0030)  MISSED
	FString                                            DestSessionId;                                              // 0x03A0   (0x0010)  
	FPartyReservation                                  PendingReservation;                                         // 0x03B0   (0x0050)  
	EClientRequestType                                 RequestType;                                                // 0x0400   (0x0001)  
	...
	// void ServerUpdateReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                             // [0x2f0af40] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerReservationRequest
	// void ServerReservationRequest(FString SessionId, FPartyReservation Reservation);                                         // [0x2f0aab0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerRemoveMemberFromReservationRequest
	// void ServerRemoveMemberFromReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                   // [0x2f0a820] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl PartyLeader);                                                       // [0x2f0a6c0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0x2f0a010] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                        // [0x2862280] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                                // [0x2f09f10] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                          // [0x2f09e10] Net|NetReliableNative|Event|Public|NetClient 
};

/// Class /Script/OnlineSubsystemUtils.PartyBeaconHost
/// Size: 0x0078 (120 bytes) (0x000308 - 0x000380) align 8 pad: 0x0000
class APartyBeaconHost : public AOnlineBeaconHostObject
{ 
public:
	class UPartyBeaconState*                           State;                                                      // 0x0308   (0x0008)  
	unsigned char                                      UnknownData00_6[0x60];                                      // 0x0310   (0x0060)  MISSED
	bool                                               bLogoutOnSessionTimeout;                                    // 0x0370   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0371   (0x0003)  MISSED
	float                                              SessionTimeoutSecs;                                         // 0x0374   (0x0004)  
	float                                              TravelSessionTimeoutSecs;                                   // 0x0378   (0x0004)  
	unsigned char                                      UnknownData02_7[0x4];                                       // 0x037C   (0x0004)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(16,693) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,694) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	unsigned char                                      UnknownData00_7[0x28];                                      // 0x0050   (0x0028)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.QuitMatchCallbackProxy.QuitMatch
	// class UQuitMatchCallbackProxy* QuitMatch(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TEnumAsByte<EMPMatchOutcome> Outcome, int32_t TurnTimeoutInSeconds); // [0x2f0a4f0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,695) /* FMulticastInlineDelegate */ __um(OnSuccess);                                          // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,696) /* FMulticastInlineDelegate */ __um(OnFailure);                                          // 0x0040   (0x0010)  
	...
	// class UShowLoginUICallbackProxy* ShowExternalLoginUI(class UObject* WorldContextObject, class APlayerController* InPlayerController); // [0x2f0b1d0] Final|Native|Static|Public|BlueprintCallable 
};
...
/// Size: 0x00E8 (232 bytes) (0x000370 - 0x000458) align 8 pad: 0x0000
class ASpectatorBeaconClient : public AOnlineBeaconClient
{ 
public:
	unsigned char                                      UnknownData00_3[0x30];                                      // 0x0370   (0x0030)  MISSED
	FString                                            DestSessionId;                                              // 0x03A0   (0x0010)  
	FSpectatorReservation                              PendingReservation;                                         // 0x03B0   (0x0078)  
	ESpectatorClientRequestType                        RequestType;                                                // 0x0428   (0x0001)  
	bool                                               bPendingReservationSent;                                    // 0x0429   (0x0001)  
	bool                                               bCancelReservation;                                         // 0x042A   (0x0001)  
	unsigned char                                      UnknownData01_7[0x2D];                                      // 0x042B   (0x002D)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerReservationRequest
	// void ServerReservationRequest(FString SessionId, FSpectatorReservation Reservation);                                     // [0x2f0ad40] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl Spectator);                                                         // [0x2f0a6c0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0x2f0a0a0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                        // [0xdb5170] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                            // [0x2f09f90] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                      // [0x2f09e90] Net|NetReliableNative|Event|Public|NetClient 
};
...
{ 
public:
	class USpectatorBeaconState*                       State;                                                      // 0x0308   (0x0008)  
	unsigned char                                      UnknownData00_6[0x60];                                      // 0x0310   (0x0060)  MISSED
	bool                                               bLogoutOnSessionTimeout;                                    // 0x0370   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0371   (0x0003)  MISSED
	float                                              SessionTimeoutSecs;                                         // 0x0374   (0x0004)  
...
/// Size: 0x0000 (0 bytes) (0x000370 - 0x000370) align 8 pad: 0x0000
...
public:
	...
	// void ServerPong();                                                                                                       // [0x2f0a7d0] Net|NetReliableNative|Event|Public|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.TestBeaconClient.ClientPing
	// void ClientPing();                                                                                                       // [0x2856bf0] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// void RegisterTurnBasedMatchInterfaceObject(class UObject* WorldContextObject, class APlayerController* PlayerController, class UObject* Object); // [0x2f0be20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetPlayerDisplayName
	// void GetPlayerDisplayName(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t PlayerIndex, FString& PlayerDisplayName); // [0x2f0bbf0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetMyPlayerIndex
	// void GetMyPlayerIndex(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t& PlayerIndex); // [0x2f0ba40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetIsMyTurn
	// void GetIsMyTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, bool& bIsMyTurn); // [0x2f0b890] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};

/// Class /Script/OnlineSubsystemUtils.VoipListenerSynthComponent
/// Size: 0x0060 (96 bytes) (0x0006F0 - 0x000750) align 16 pad: 0x0000
class UVoipListenerSynthComponent : public USynthComponent
{ 
public:
	unsigned char                                      UnknownData00_1[0x60];                                      // 0x06F0   (0x0060)  MISSED


	/// Functions
	// Function /Script/OnlineSubsystemUtils.VoipListenerSynthComponent.IsIdling
	// bool IsIdling();                                                                                                         // [0x2f0bdf0] Final|Native|Public|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(80,697) /* TMap<FString, FString> */ __um(DynamicFields);                                        // 0x00C0   (0x0050)  
};
...
{ 
	...
	SDK_UNDEFINED(80,698) /* TMap<FString, FString> */ __um(DynamicFields);                                        // 0x00A8   (0x0050)  
};
...
static_assert(sizeof(UIpNetDriver) == 0x0908); // 2312 bytes (0x000898 - 0x000908)
static_assert(sizeof(UIpConnection) == 0x1C18); // 7192 bytes (0x001B78 - 0x001C18)
...
static_assert(sizeof(AOnlineBeacon) == 0x0310); // 784 bytes (0x0002E0 - 0x000310)
static_assert(sizeof(AOnlineBeaconClient) == 0x0370); // 880 bytes (0x000310 - 0x000370)
static_assert(sizeof(AOnlineBeaconHost) == 0x03C8); // 968 bytes (0x000310 - 0x0003C8)
static_assert(sizeof(AOnlineBeaconHostObject) == 0x0308); // 776 bytes (0x0002E0 - 0x000308)
...
static_assert(sizeof(APartyBeaconClient) == 0x0430); // 1072 bytes (0x000370 - 0x000430)
static_assert(sizeof(APartyBeaconHost) == 0x0380); // 896 bytes (0x000308 - 0x000380)
...
static_assert(sizeof(ASpectatorBeaconClient) == 0x0458); // 1112 bytes (0x000370 - 0x000458)
static_assert(sizeof(ASpectatorBeaconHost) == 0x0380); // 896 bytes (0x000308 - 0x000380)
static_assert(sizeof(USpectatorBeaconState) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(ATestBeaconClient) == 0x0370); // 880 bytes (0x000370 - 0x000370)
static_assert(sizeof(ATestBeaconHost) == 0x0308); // 776 bytes (0x000308 - 0x000308)
static_assert(sizeof(UTurnBasedBlueprintLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UVoipListenerSynthComponent) == 0x0750); // 1872 bytes (0x0006F0 - 0x000750)
...
static_assert(offsetof(AOnlineBeacon, NetDriver) == 0x02F0);
static_assert(offsetof(AOnlineBeaconClient, BeaconOwner) == 0x0310);
static_assert(offsetof(AOnlineBeaconClient, BeaconConnection) == 0x0318);
static_assert(offsetof(AOnlineBeaconClient, ConnectionState) == 0x0320);
static_assert(offsetof(AOnlineBeaconHost, ClientActors) == 0x0318);
static_assert(offsetof(AOnlineBeaconHostObject, BeaconTypeName) == 0x02E0);
static_assert(offsetof(AOnlineBeaconHostObject, ClientBeaconActorClass) == 0x02F0);
static_assert(offsetof(AOnlineBeaconHostObject, ClientActors) == 0x02F8);
...
static_assert(offsetof(APartyBeaconClient, DestSessionId) == 0x03A0);
static_assert(offsetof(APartyBeaconClient, PendingReservation) == 0x03B0);
static_assert(offsetof(APartyBeaconClient, RequestType) == 0x0400);
static_assert(offsetof(APartyBeaconHost, State) == 0x0308);
...
static_assert(offsetof(ASpectatorBeaconClient, DestSessionId) == 0x03A0);
static_assert(offsetof(ASpectatorBeaconClient, PendingReservation) == 0x03B0);
static_assert(offsetof(ASpectatorBeaconClient, RequestType) == 0x0428);
static_assert(offsetof(ASpectatorBeaconHost, State) == 0x0308);
