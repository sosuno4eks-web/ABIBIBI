...
{ 
public:
	class UGroomComponent*                             GroomComponent;                                             // 0x02E0   (0x0008)  
};
...
{ 
	...
	SDK_UNDEFINED(40,2674) /* TWeakObjectPtr<UNiagaraSystem*> */ __um(CustomSystem);                               // 0x0008   (0x0028)  
...
public:
	...
	FPerPlatformInt                                    MinLOD;                                                     // 0x00C4   (0x0008)  
	FPerPlatformBool                                   DisableBelowMinLodStripping;                                // 0x00CC   (0x0001)  
...
public:
	...
	// class UGroomBindingAsset* CreateNewGroomBindingAssetWithPath(FString InDesiredPackagePath, class UGroomAsset* InGroomAsset, class USkeletalMesh* InSkeletalMesh, int32_t InNumInterpolationPoints, class USkeletalMesh* InSourceSkeletalMeshForTransfer, int32_t InMatchingSection); // [0x15d6b50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/HairStrandsCore.GroomBlueprintLibrary.CreateNewGroomBindingAsset
	// class UGroomBindingAsset* CreateNewGroomBindingAsset(class UGroomAsset* InGroomAsset, class USkeletalMesh* InSkeletalMesh, int32_t InNumInterpolationPoints, class USkeletalMesh* InSourceSkeletalMeshForTransfer, int32_t InMatchingSection); // [0x15d69c0] Final|Native|Static|Public|BlueprintCallable 
};
...
/// Size: 0x0110 (272 bytes) (0x000610 - 0x000720) align 16 pad: 0x0000
class UGroomComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x8];                                       // 0x0610   (0x0008)  MISSED
	class UGroomAsset*                                 GroomAsset;                                                 // 0x0618   (0x0008)  
	TArray<class UNiagaraComponent*>                   NiagaraComponents;                                          // 0x0620   (0x0010)  
	class USkeletalMesh*                               SourceSkeletalMesh;                                         // 0x0630   (0x0008)  
	class UGroomBindingAsset*                          BindingAsset;                                               // 0x0638   (0x0008)  
	class UPhysicsAsset*                               PhysicsAsset;                                               // 0x0640   (0x0008)  
	class UMaterialInterface*                          Strands_DebugMaterial;                                      // 0x0648   (0x0008)  
	class UMaterialInterface*                          Strands_DefaultMaterial;                                    // 0x0650   (0x0008)  
	class UMaterialInterface*                          Cards_DefaultMaterial;                                      // 0x0658   (0x0008)  
	class UMaterialInterface*                          Meshes_DefaultMaterial;                                     // 0x0660   (0x0008)  
	class UNiagaraSystem*                              AngularSpringsSystem;                                       // 0x0668   (0x0008)  
	class UNiagaraSystem*                              CosseratRodsSystem;                                         // 0x0670   (0x0008)  
	FString                                            AttachmentName;                                             // 0x0678   (0x0010)  
	unsigned char                                      UnknownData01_6[0x48];                                      // 0x0688   (0x0048)  MISSED
	TArray<FHairGroupDesc>                             GroomGroupsDesc;                                            // 0x06D0   (0x0010)  
	unsigned char                                      UnknownData02_7[0x40];                                      // 0x06E0   (0x0040)  MISSED


	/// Functions
	// Function /Script/HairStrandsCore.GroomComponent.SetGroomAsset
	// void SetGroomAsset(class UGroomAsset* Asset);                                                                            // [0x15d6dc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/HairStrandsCore.GroomComponent.SetBindingAsset
	// void SetBindingAsset(class UGroomBindingAsset* InBinding);                                                               // [0x15d6d30] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(AGroomActor) == 0x02E8); // 744 bytes (0x0002E0 - 0x0002E8)
...
static_assert(sizeof(UGroomComponent) == 0x0720); // 1824 bytes (0x000610 - 0x000720)
...
static_assert(offsetof(AGroomActor, GroomComponent) == 0x02E0);
...
static_assert(offsetof(UGroomAsset, DisableBelowMinLodStripping) == 0x00CC);
...
static_assert(offsetof(UGroomComponent, GroomAsset) == 0x0618);
static_assert(offsetof(UGroomComponent, NiagaraComponents) == 0x0620);
static_assert(offsetof(UGroomComponent, SourceSkeletalMesh) == 0x0630);
static_assert(offsetof(UGroomComponent, BindingAsset) == 0x0638);
static_assert(offsetof(UGroomComponent, PhysicsAsset) == 0x0640);
static_assert(offsetof(UGroomComponent, Strands_DebugMaterial) == 0x0648);
static_assert(offsetof(UGroomComponent, Strands_DefaultMaterial) == 0x0650);
static_assert(offsetof(UGroomComponent, Cards_DefaultMaterial) == 0x0658);
static_assert(offsetof(UGroomComponent, Meshes_DefaultMaterial) == 0x0660);
static_assert(offsetof(UGroomComponent, AngularSpringsSystem) == 0x0668);
static_assert(offsetof(UGroomComponent, CosseratRodsSystem) == 0x0670);
static_assert(offsetof(UGroomComponent, AttachmentName) == 0x0678);
static_assert(offsetof(UGroomComponent, GroomGroupsDesc) == 0x06D0);
