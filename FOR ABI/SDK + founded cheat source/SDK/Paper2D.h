...
/// Size: 0x0008 (8 bytes) (0x0005A8 - 0x0005B0) align 16 pad: 0x0000
class APaperCharacter : public ACharacter
{ 
public:
	class UPaperFlipbookComponent*                     Sprite;                                                     // 0x05A8   (0x0008)  
};
...
public:
	...
	// bool IsValidKeyFrameIndex(int32_t Index);                                                                                // [0x187fff0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetTotalDuration
	// float GetTotalDuration();                                                                                                // [0x187ff30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtTime
	// class UPaperSprite* GetSpriteAtTime(float Time, bool bClampToEnds);                                                      // [0x187f610] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtFrame
	// class UPaperSprite* GetSpriteAtFrame(int32_t FrameIndex);                                                                // [0x187f570] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumKeyFrames
	// int32_t GetNumKeyFrames();                                                                                               // [0x187f430] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumFrames
	// int32_t GetNumFrames();                                                                                                  // [0x187f400] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetKeyFrameIndexAtTime
	// int32_t GetKeyFrameIndexAtTime(float Time, bool bClampToEnds);                                                           // [0x187f150] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	class UPaperFlipbookComponent*                     RenderComponent;                                            // 0x02E0   (0x0008)  
};

/// Class /Script/Paper2D.PaperFlipbookComponent
/// Size: 0x0050 (80 bytes) (0x000610 - 0x000660) align 16 pad: 0x0000
class UPaperFlipbookComponent : public UMeshComponent
{ 
public:
	class UPaperFlipbook*                              SourceFlipbook;                                             // 0x0610   (0x0008)  
	class UMaterialInterface*                          Material;                                                   // 0x0618   (0x0008)  
	float                                              PlayRate;                                                   // 0x0620   (0x0004)  
	bool                                               bLooping : 1;                                               // 0x0624:0 (0x0001)  
	bool                                               bReversePlayback : 1;                                       // 0x0624:1 (0x0001)  
	bool                                               bPlaying : 1;                                               // 0x0624:2 (0x0001)  
	unsigned char                                      UnknownData00_5[0x3];                                       // 0x0625   (0x0003)  MISSED
	float                                              AccumulatedTime;                                            // 0x0628   (0x0004)  
	int32_t                                            CachedFrameIndex;                                           // 0x062C   (0x0004)  
	FLinearColor                                       SpriteColor;                                                // 0x0630   (0x0010)  
	class UBodySetup*                                  CachedBodySetup;                                            // 0x0640   (0x0008)  
	SDK_UNDEFINED(16,2255) /* FMulticastInlineDelegate */ __um(OnFinishedPlaying);                                 // 0x0648   (0x0010)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x0658   (0x0008)  MISSED


	/// Functions
	// Function /Script/Paper2D.PaperFlipbookComponent.Stop
	// void Stop();                                                                                                             // [0x1881310] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetSpriteColor
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0x1880ec0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlayRate
	// void SetPlayRate(float NewRate);                                                                                         // [0x1880c90] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPositionInFrames
	// void SetPlaybackPositionInFrames(int32_t NewFramePosition, bool bFireEvents);                                            // [0x1880df0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPosition
	// void SetPlaybackPosition(float NewPosition, bool bFireEvents);                                                           // [0x1880d10] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetNewTime
	// void SetNewTime(float NewTime);                                                                                          // [0x1880c10] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetLooping
	// void SetLooping(bool bNewLooping);                                                                                       // [0x1880b80] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetFlipbook
	// bool SetFlipbook(class UPaperFlipbook* NewFlipbook);                                                                     // [0x18807d0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.ReverseFromEnd
	// void ReverseFromEnd();                                                                                                   // [0x18806d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Reverse
	// void Reverse();                                                                                                          // [0x18806b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.PlayFromStart
	// void PlayFromStart();                                                                                                    // [0x1880500] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Play
	// void Play();                                                                                                             // [0x18804e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.OnRep_SourceFlipbook
	// void OnRep_SourceFlipbook(class UPaperFlipbook* OldFlipbook);                                                            // [0x1880420] Final|Native|Protected 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsReversing
	// bool IsReversing();                                                                                                      // [0x187ffc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x187ff90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsLooping
	// bool IsLooping();                                                                                                        // [0x187ff60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetSpriteColor
	// FLinearColor GetSpriteColor();                                                                                           // [0x187f6e0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlayRate
	// float GetPlayRate();                                                                                                     // [0x187f450] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPositionInFrames
	// int32_t GetPlaybackPositionInFrames();                                                                                   // [0x187f4b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPosition
	// float GetPlaybackPosition();                                                                                             // [0x187f480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLengthInFrames
	// int32_t GetFlipbookLengthInFrames();                                                                                     // [0x187ef90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLength
	// float GetFlipbookLength();                                                                                               // [0x187ef60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookFramerate
	// float GetFlipbookFramerate();                                                                                            // [0x187ef30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbook
	// class UPaperFlipbook* GetFlipbook();                                                                                     // [0x187ef00] Native|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	class UPaperGroupedSpriteComponent*                RenderComponent;                                            // 0x02E0   (0x0008)  
};
...
{ 
public:
	TArray<class UMaterialInterface*>                  InstanceMaterials;                                          // 0x0610   (0x0010)  
	TArray<FSpriteInstanceData>                        PerInstanceSpriteData;                                      // 0x0620   (0x0010)  
	...
	// bool UpdateInstanceTransform(int32_t InstanceIndex, FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport); // [0x1881450] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.UpdateInstanceColor
	// bool UpdateInstanceColor(int32_t InstanceIndex, FLinearColor NewInstanceColor, bool bMarkRenderStateDirty);              // [0x1881330] Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.SortInstancesAlongAxis
	// void SortInstancesAlongAxis(FVector WorldSpaceSortAxis);                                                                 // [0x1881280] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.RemoveInstance
	// bool RemoveInstance(int32_t InstanceIndex);                                                                              // [0x1880540] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceTransform
	// bool GetInstanceTransform(int32_t InstanceIndex, FTransform& OutInstanceTransform, bool bWorldSpace);                    // [0x187eff0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceCount
	// int32_t GetInstanceCount();                                                                                              // [0x187efc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.ClearInstances
	// void ClearInstances();                                                                                                   // [0x187ec80] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.AddInstance
	// int32_t AddInstance(FTransform& Transform, class UPaperSprite* Sprite, bool bWorldSpace, FLinearColor Color);            // [0x187e850] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
{ 
public:
	class UPaperSpriteComponent*                       RenderComponent;                                            // 0x02E0   (0x0008)  
};
...
public:
	...
	// FSlateBrush MakeBrushFromSprite(class UPaperSprite* Sprite, int32_t Width, int32_t Height);                              // [0x1880090] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.PaperSpriteBlueprintLibrary.GetTopLeftPosInPercent
	// FVector2D GetTopLeftPosInPercent(class UPaperSprite* Sprite);                                                            // [0x187fea0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.PaperSpriteBlueprintLibrary.GetSourceTextureOfSprite
	// class UTexture2D* GetSourceTextureOfSprite(class UPaperSprite* Sprite);                                                  // [0x187f4e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.PaperSpriteBlueprintLibrary.GetBottomRightPosInPercent
	// FVector2D GetBottomRightPosInPercent(class UPaperSprite* Sprite);                                                        // [0x187ee70] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};

/// Class /Script/Paper2D.PaperSpriteComponent
/// Size: 0x0020 (32 bytes) (0x000610 - 0x000630) align 16 pad: 0x0000
class UPaperSpriteComponent : public UMeshComponent
{ 
public:
	class UPaperSprite*                                SourceSprite;                                               // 0x0610   (0x0008)  
	class UMaterialInterface*                          MaterialOverride;                                           // 0x0618   (0x0008)  
	FLinearColor                                       SpriteColor;                                                // 0x0620   (0x0010)  


	/// Functions
	// Function /Script/Paper2D.PaperSpriteComponent.SetSpriteColor
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0x1880f50] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.SetSprite
	// bool SetSprite(class UPaperSprite* NewSprite);                                                                           // [0x18807d0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.GetSprite
	// class UPaperSprite* GetSprite();                                                                                         // [0x187ef00] Native|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	class USceneComponent*                             DummyRoot;                                                  // 0x02E0   (0x0008)  
	class UPaperTerrainSplineComponent*                SplineComponent;                                            // 0x02E8   (0x0008)  
	class UPaperTerrainComponent*                      RenderComponent;                                            // 0x02F0   (0x0008)  
};
...
{ 
public:
	class UPaperTerrainMaterial*                       TerrainMaterial;                                            // 0x05D8   (0x0008)  
	bool                                               bClosedSpline;                                              // 0x05E0   (0x0001)  
	bool                                               bFilledSpline;                                              // 0x05E1   (0x0001)  
	unsigned char                                      UnknownData00_6[0x6];                                       // 0x05E2   (0x0006)  MISSED
	class UPaperTerrainSplineComponent*                AssociatedSpline;                                           // 0x05E8   (0x0008)  
	int32_t                                            RandomSeed;                                                 // 0x05F0   (0x0004)  
	float                                              SegmentOverlapAmount;                                       // 0x05F4   (0x0004)  
	FLinearColor                                       TerrainColor;                                               // 0x05F8   (0x0010)  
	int32_t                                            ReparamStepsPerSegment;                                     // 0x0608   (0x0004)  
	TEnumAsByte<ESpriteCollisionMode>                  SpriteCollisionDomain;                                      // 0x060C   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x060D   (0x0003)  MISSED
	float                                              CollisionThickness;                                         // 0x0610   (0x0004)  
	unsigned char                                      UnknownData02_6[0x4];                                       // 0x0614   (0x0004)  MISSED
	class UBodySetup*                                  CachedBodySetup;                                            // 0x0618   (0x0008)  
	unsigned char                                      UnknownData03_7[0x10];                                      // 0x0620   (0x0010)  MISSED


	/// Functions
	// Function /Script/Paper2D.PaperTerrainComponent.SetTerrainColor
	// void SetTerrainColor(FLinearColor NewColor);                                                                             // [0x1880fe0] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0010 (16 bytes) (0x0006D0 - 0x0006E0) align 16 pad: 0x0000
...
public:
	...
	SDK_UNDEFINED(40,2256) /* TWeakObjectPtr<UPaperTileSet*> */ __um(SelectedTileSet);                             // 0x0048   (0x0028)  
...
{ 
public:
	class UPaperTileMapComponent*                      RenderComponent;                                            // 0x02E0   (0x0008)  
};
...
{ 
public:
	int32_t                                            MapWidth;                                                   // 0x0610   (0x0004)  
	int32_t                                            MapHeight;                                                  // 0x0614   (0x0004)  
	int32_t                                            TileWidth;                                                  // 0x0618   (0x0004)  
	int32_t                                            TileHeight;                                                 // 0x061C   (0x0004)  
	class UPaperTileSet*                               DefaultLayerTileSet;                                        // 0x0620   (0x0008)  
	class UMaterialInterface*                          Material;                                                   // 0x0628   (0x0008)  
	TArray<class UPaperTileLayer*>                     TileLayers;                                                 // 0x0630   (0x0010)  
	FLinearColor                                       TileMapColor;                                               // 0x0640   (0x0010)  
	int32_t                                            UseSingleLayerIndex;                                        // 0x0650   (0x0004)  
	bool                                               bUseSingleLayer;                                            // 0x0654   (0x0001)  
	unsigned char                                      UnknownData00_6[0x3];                                       // 0x0655   (0x0003)  MISSED
	class UPaperTileMap*                               TileMap;                                                    // 0x0658   (0x0008)  


	/// Functions
	// Function /Script/Paper2D.PaperTileMapComponent.SetTileMapColor
	// void SetTileMapColor(FLinearColor NewColor);                                                                             // [0x18811f0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTileMap
	// bool SetTileMap(class UPaperTileMap* NewTileMap);                                                                        // [0x18807d0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTile
	// void SetTile(int32_t X, int32_t Y, int32_t Layer, FPaperTileInfo NewValue);                                              // [0x1881070] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerColor
	// void SetLayerColor(FLinearColor NewColor, int32_t Layer);                                                                // [0x1880ab0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerCollision
	// void SetLayerCollision(int32_t Layer, bool bHasCollision, bool bOverrideThickness, float CustomThickness, bool bOverrideOffset, float CustomOffset, bool bRebuildCollision); // [0x1880870] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetDefaultCollisionThickness
	// void SetDefaultCollisionThickness(float Thickness, bool bRebuildCollision);                                              // [0x18806f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.ResizeMap
	// void ResizeMap(int32_t NewWidthInTiles, int32_t NewHeightInTiles);                                                       // [0x18805e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.RebuildCollision
	// void RebuildCollision();                                                                                                 // [0x1880520] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.OwnsTileMap
	// bool OwnsTileMap();                                                                                                      // [0x18804b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.MakeTileMapEditable
	// void MakeTileMapEditable();                                                                                              // [0x1880400] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTilePolygon
	// void GetTilePolygon(int32_t TileX, int32_t TileY, TArray<FVector>& Points, int32_t LayerIndex, bool bWorldSpace);        // [0x187fb50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileMapColor
	// FLinearColor GetTileMapColor();                                                                                          // [0x187fb10] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCornerPosition
	// FVector GetTileCornerPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace);                       // [0x187f9a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCenterPosition
	// FVector GetTileCenterPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace);                       // [0x187f830] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTile
	// FPaperTileInfo GetTile(int32_t X, int32_t Y, int32_t Layer);                                                             // [0x187f710] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetMapSize
	// void GetMapSize(int32_t& MapWidth, int32_t& MapHeight, int32_t& NumLayers);                                              // [0x187f2c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetLayerColor
	// FLinearColor GetLayerColor(int32_t Layer);                                                                               // [0x187f220] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.CreateNewTileMap
	// void CreateNewTileMap(int32_t MapWidth, int32_t MapHeight, int32_t TileWidth, int32_t TileHeight, float PixelsPerUnrealUnit, bool bCreateLayer); // [0x187eca0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.AddNewLayer
	// class UPaperTileLayer* AddNewLayer();                                                                                    // [0x187ea20] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FPaperTileInfo MakeTile(int32_t TileIndex, class UPaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD);         // [0x1880230] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileUserData
	// FName GetTileUserData(FPaperTileInfo Tile);                                                                              // [0x187fe00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileTransform
	// FTransform GetTileTransform(FPaperTileInfo Tile);                                                                        // [0x187fd20] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.BreakTile
	// void BreakTile(FPaperTileInfo Tile, int32_t& TileIndex, class UPaperTileSet*& TileSet, bool& bFlipH, bool& bFlipV, bool& bFlipD); // [0x187ea50] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
{ 
	SDK_UNDEFINED(40,2257) /* TWeakObjectPtr<UPaperSprite*> */ __um(SpriteRef);                                    // 0x0000   (0x0028)  
...
static_assert(sizeof(APaperCharacter) == 0x05B0); // 1456 bytes (0x0005A8 - 0x0005B0)
...
static_assert(sizeof(APaperFlipbookActor) == 0x02E8); // 744 bytes (0x0002E0 - 0x0002E8)
static_assert(sizeof(UPaperFlipbookComponent) == 0x0660); // 1632 bytes (0x000610 - 0x000660)
static_assert(sizeof(APaperGroupedSpriteActor) == 0x02E8); // 744 bytes (0x0002E0 - 0x0002E8)
static_assert(sizeof(FSpriteInstanceData) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(UPaperGroupedSpriteComponent) == 0x0640); // 1600 bytes (0x000610 - 0x000640)
...
static_assert(sizeof(APaperSpriteActor) == 0x02E8); // 744 bytes (0x0002E0 - 0x0002E8)
...
static_assert(sizeof(UPaperSpriteComponent) == 0x0630); // 1584 bytes (0x000610 - 0x000630)
static_assert(sizeof(APaperTerrainActor) == 0x02F8); // 760 bytes (0x0002E0 - 0x0002F8)
static_assert(sizeof(UPaperTerrainComponent) == 0x0630); // 1584 bytes (0x0005D8 - 0x000630)
...
static_assert(sizeof(UPaperTerrainSplineComponent) == 0x06E0); // 1760 bytes (0x0006D0 - 0x0006E0)
...
static_assert(sizeof(APaperTileMapActor) == 0x02E8); // 744 bytes (0x0002E0 - 0x0002E8)
static_assert(sizeof(UPaperTileMapComponent) == 0x0660); // 1632 bytes (0x000610 - 0x000660)
...
static_assert(offsetof(APaperCharacter, Sprite) == 0x05A8);
...
static_assert(offsetof(APaperFlipbookActor, RenderComponent) == 0x02E0);
static_assert(offsetof(UPaperFlipbookComponent, SourceFlipbook) == 0x0610);
static_assert(offsetof(UPaperFlipbookComponent, Material) == 0x0618);
static_assert(offsetof(UPaperFlipbookComponent, SpriteColor) == 0x0630);
static_assert(offsetof(UPaperFlipbookComponent, CachedBodySetup) == 0x0640);
static_assert(offsetof(APaperGroupedSpriteActor, RenderComponent) == 0x02E0);
...
static_assert(offsetof(UPaperGroupedSpriteComponent, InstanceMaterials) == 0x0610);
static_assert(offsetof(UPaperGroupedSpriteComponent, PerInstanceSpriteData) == 0x0620);
...
static_assert(offsetof(APaperSpriteActor, RenderComponent) == 0x02E0);
static_assert(offsetof(UPaperSpriteComponent, SourceSprite) == 0x0610);
static_assert(offsetof(UPaperSpriteComponent, MaterialOverride) == 0x0618);
static_assert(offsetof(UPaperSpriteComponent, SpriteColor) == 0x0620);
static_assert(offsetof(APaperTerrainActor, DummyRoot) == 0x02E0);
static_assert(offsetof(APaperTerrainActor, SplineComponent) == 0x02E8);
static_assert(offsetof(APaperTerrainActor, RenderComponent) == 0x02F0);
static_assert(offsetof(UPaperTerrainComponent, TerrainMaterial) == 0x05D8);
static_assert(offsetof(UPaperTerrainComponent, AssociatedSpline) == 0x05E8);
static_assert(offsetof(UPaperTerrainComponent, TerrainColor) == 0x05F8);
static_assert(offsetof(UPaperTerrainComponent, SpriteCollisionDomain) == 0x060C);
static_assert(offsetof(UPaperTerrainComponent, CachedBodySetup) == 0x0618);
...
static_assert(offsetof(APaperTileMapActor, RenderComponent) == 0x02E0);
static_assert(offsetof(UPaperTileMapComponent, DefaultLayerTileSet) == 0x0620);
static_assert(offsetof(UPaperTileMapComponent, Material) == 0x0628);
static_assert(offsetof(UPaperTileMapComponent, TileLayers) == 0x0630);
static_assert(offsetof(UPaperTileMapComponent, TileMapColor) == 0x0640);
static_assert(offsetof(UPaperTileMapComponent, TileMap) == 0x0658);
