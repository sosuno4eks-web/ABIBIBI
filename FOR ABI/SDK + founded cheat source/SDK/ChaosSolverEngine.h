...
/// Size: 0x01B8 (440 bytes) (0x000100 - 0x0002B8) align 8 pad: 0x0000
class UChaosGameplayEventDispatcher : public UChaosEventListenerComponent
{ 
public:
	unsigned char                                      UnknownData00_3[0x110];                                     // 0x0100   (0x0110)  MISSED
	SDK_UNDEFINED(80,2211) /* TMap<UPrimitiveComponent*, FChaosHandlerSet> */ __um(CollisionEventRegistrations);   // 0x0210   (0x0050)  
	SDK_UNDEFINED(80,2212) /* TMap<UPrimitiveComponent*, FBreakEventCallbackWrapper> */ __um(BreakEventRegistrations); // 0x0260   (0x0050)  
...
public:
	...
	// FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision);                             // [0x5e9da90] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
/// Size: 0x00F8 (248 bytes) (0x0002E0 - 0x0003D8) align 8 pad: 0x0000
class AChaosSolverActor : public AActor
{ 
public:
	FChaosSolverConfiguration                          Properties;                                                 // 0x02E0   (0x0068)  
	float                                              TimeStepMultiplier;                                         // 0x0348   (0x0004)  
	int32_t                                            CollisionIterations;                                        // 0x034C   (0x0004)  
	int32_t                                            PushOutIterations;                                          // 0x0350   (0x0004)  
	int32_t                                            PushOutPairIterations;                                      // 0x0354   (0x0004)  
	float                                              ClusterConnectionFactor;                                    // 0x0358   (0x0004)  
	EClusterConnectionTypeEnum                         ClusterUnionConnectionType;                                 // 0x035C   (0x0001)  
	bool                                               DoGenerateCollisionData;                                    // 0x035D   (0x0001)  
	unsigned char                                      UnknownData00_6[0x2];                                       // 0x035E   (0x0002)  MISSED
	FSolverCollisionFilterSettings                     CollisionFilterSettings;                                    // 0x0360   (0x0010)  
	bool                                               DoGenerateBreakingData;                                     // 0x0370   (0x0001)  
	unsigned char                                      UnknownData01_6[0x3];                                       // 0x0371   (0x0003)  MISSED
	FSolverBreakingFilterSettings                      BreakingFilterSettings;                                     // 0x0374   (0x0010)  
	bool                                               DoGenerateTrailingData;                                     // 0x0384   (0x0001)  
	unsigned char                                      UnknownData02_6[0x3];                                       // 0x0385   (0x0003)  MISSED
	FSolverTrailingFilterSettings                      TrailingFilterSettings;                                     // 0x0388   (0x0010)  
	float                                              MassScale;                                                  // 0x0398   (0x0004)  
	bool                                               bGenerateContactGraph;                                      // 0x039C   (0x0001)  
	bool                                               bHasFloor;                                                  // 0x039D   (0x0001)  
	unsigned char                                      UnknownData03_6[0x2];                                       // 0x039E   (0x0002)  MISSED
	float                                              FloorHeight;                                                // 0x03A0   (0x0004)  
	FChaosDebugSubstepControl                          ChaosDebugSubstepControl;                                   // 0x03A4   (0x0003)  
	unsigned char                                      UnknownData04_6[0x1];                                       // 0x03A7   (0x0001)  MISSED
	class UBillboardComponent*                         SpriteComponent;                                            // 0x03A8   (0x0008)  
	unsigned char                                      UnknownData05_6[0x18];                                      // 0x03B0   (0x0018)  MISSED
	class UChaosGameplayEventDispatcher*               GameplayEventDispatcherComponent;                           // 0x03C8   (0x0008)  
	unsigned char                                      UnknownData06_7[0x8];                                       // 0x03D0   (0x0008)  MISSED


	/// Functions
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetSolverActive
	// void SetSolverActive(bool bActive);                                                                                      // [0x1087c90] Native|Public|BlueprintCallable 
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver
	// void SetAsCurrentWorldSolver();                                                                                          // [0x5e9db90] Final|Native|Public|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(80,2213) /* TSet<UObject*> */        __um(ChaosHandlers);                                        // 0x0008   (0x0050)  
};
...
static_assert(sizeof(UChaosDebugDrawComponent) == 0x0100); // 256 bytes (0x0000F8 - 0x000100)
static_assert(sizeof(UChaosEventListenerComponent) == 0x0100); // 256 bytes (0x0000F8 - 0x000100)
static_assert(sizeof(UChaosGameplayEventDispatcher) == 0x02B8); // 696 bytes (0x000100 - 0x0002B8)
...
static_assert(sizeof(AChaosSolverActor) == 0x03D8); // 984 bytes (0x0002E0 - 0x0003D8)
...
static_assert(offsetof(AChaosSolverActor, Properties) == 0x02E0);
static_assert(offsetof(AChaosSolverActor, ClusterUnionConnectionType) == 0x035C);
static_assert(offsetof(AChaosSolverActor, CollisionFilterSettings) == 0x0360);
static_assert(offsetof(AChaosSolverActor, BreakingFilterSettings) == 0x0374);
static_assert(offsetof(AChaosSolverActor, TrailingFilterSettings) == 0x0388);
static_assert(offsetof(AChaosSolverActor, ChaosDebugSubstepControl) == 0x03A4);
static_assert(offsetof(AChaosSolverActor, SpriteComponent) == 0x03A8);
static_assert(offsetof(AChaosSolverActor, GameplayEventDispatcherComponent) == 0x03C8);
