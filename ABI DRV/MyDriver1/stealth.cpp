...
BOOLEAN StorageWipePiDDBCacheTable()
{
    __try {
        ...
        // Pattern for PiDDBCacheTable (Windows 11 23H2)
        UCHAR pattern[] = {
        ...
        __try {
            ...
            while (current != listHead) {
                ...
                // Check for our driver (generic name to avoid detection)
...
BOOLEAN StorageClearMmUnloadedDrivers()
{
    __try {
        ...
        // Pattern for MmUnloadedDrivers (Windows 11 23H2)
        UCHAR pattern[] = {
        ...
        __try {
            RtlZeroMemory(mmUnloadedDrivers, *mmUnloadedDriversCount * sizeof(PVOID));
...
/* ── Header Scrubbing - Break Signature Scanners ───────────────── */
