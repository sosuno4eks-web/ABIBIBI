...
public final class ue {
   ...
   @NotNull
   private static final class_11280 j;
   ...
   static {
      long var11 = j0.a(8878416883272487265L, 4830452725591107479L, MethodHandles.lookup().lookupClass()).a(161665416450775L) ^ 41433289863573L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("Iy\u0080Oà¢@Ù\u008c9?Í\u0080[\u0005\u0007ºò^\u000b«\u008d\\I".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -5469604934356625414L;
      ...
      long var0 = var14;
      X = new ue();
      M = (new Std140SizeCalculator()).putVec2().putVec4().putVec4().putVec4().putVec4().putFloat().putFloat().get();
      ue var15 = X;
      j = new class_11280(var7, M, (int)var0);
   }
