...
public final class qj {
   @NotNull
   public static final qj X;
   private static final int b;
   @NotNull
   private static final class_11280 g;
   ...
   static {
      long var11 = j0.a(2438109638886442934L, 7015108694893992495L, MethodHandles.lookup().lookupClass()).a(39661119715992L) ^ 46247820920616L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("\u001a\u001d\u008dð8\u0080\u009b\u0006ªbð_í5ç-g\u001d\u0016_êIÖ7".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -6792078636122375618L;
      ...
      long var0 = var14;
      X = new qj();
      b = (new Std140SizeCalculator()).putFloat().putVec4().putVec4().putInt().putInt().putFloat().putFloat().putInt().putFloat().putVec2().putFloat().putFloat().get();
      qj var15 = X;
      g = new class_11280(var7, b, (int)var0);
   }
