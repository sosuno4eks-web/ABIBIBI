...
public final class bb {
   ...
   @NotNull
   private static final class_11280 a;

   private bb() {
   }

   @NotNull
   public final class_11280 G() {
      return a;
   }

   static {
      long var11 = j0.a(9200797439360889462L, 5015652010600502546L, MethodHandles.lookup().lookupClass()).a(241354011648436L) ^ 102624240980285L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("o£R¬©||ØGÍÓô6 É×\u009c÷±^Ô]f¿".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = 4994607319721733500L;
      ...
      long var0 = var14;
      K = new bb();
      E = (new Std140SizeCalculator()).putVec2().putFloat().putFloat().putVec4().get();
      a = new class_11280(var7, E, (int)var0);
   }
