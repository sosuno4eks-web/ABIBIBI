...
public final class nw extends nm {
   @NotNull
   public static final nw K;
   private static final long c = j0.a(1716137054361849485L, 3089456787703959817L, MethodHandles.lookup().lookupClass()).a(12264542889147L);
   ...
   private nw(long var1) {
      var1 ^= c;
      long var3 = var1 ^ 28847478382564L;
      super(true.i<invokedynamic>(22795, 5619513578008731879L ^ var1), var3);
   }
   ...
   static {
      long var20 = c ^ 1065883010981L;
      long var22 = var20 ^ 27741940835437L;
      i = new HashMap(13);
      Cipher var11;
      ...
      int var16 = 0;
      String var15 = "\u0000bº_\u0083\u0086\u0092\u0092% o\u0088èQ\u0006\b\u009e\u000e|Xöub\u001e\u0010È¯£P\u008aÍöã\u0000GSçyqCE\u0088Ò«\u001e\u0002ú\u001a¸\twP|Y\u0096Á â4¿\f\u009bÍ&ô¯okä3\u0095\bI\u0093\u008dKÝ8\u0015ô<\u0082MÏtà©\u001e\u0088¿à\u0094¬Þ~gCã\"\b½\u0088\u0089\u0005¢5\u001cÚà\u0011Þ¤ù\u00ad[Y^\u0082»ç`Â½ñz{\u007fÇ½s0y\u0007 \u0094£\u0014Ë-â!\\\u008e¶*Õ&\u0014ñcFtôúÀ\u0090\u00150\u000bv)F\u0081(ä`\u0000æá\u0093\u009b\u0013öP-Ê\n; \u008cÑb\u0005\u000f\u0015çà_µ}¯\u009d\f8A£Újð\u0010ùIü¿\u0003è2,B{]";
      int var17 = "\u0000bº_\u0083\u0086\u0092\u0092% o\u0088èQ\u0006\b\u009e\u000e|Xöub\u001e\u0010È¯£P\u008aÍöã\u0000GSçyqCE\u0088Ò«\u001e\u0002ú\u001a¸\twP|Y\u0096Á â4¿\f\u009bÍ&ô¯okä3\u0095\bI\u0093\u008dKÝ8\u0015ô<\u0082MÏtà©\u001e\u0088¿à\u0094¬Þ~gCã\"\b½\u0088\u0089\u0005¢5\u001cÚà\u0011Þ¤ù\u00ad[Y^\u0082»ç`Â½ñz{\u007fÇ½s0y\u0007 \u0094£\u0014Ë-â!\\\u008e¶*Õ&\u0014ñcFtôúÀ\u0090\u00150\u000bv)F\u0081(ä`\u0000æá\u0093\u009b\u0013öP-Ê\n; \u008cÑb\u0005\u000f\u0015çà_µ}¯\u009d\f8A£Újð\u0010ùIü¿\u0003è2,B{]".length();
      char var14 = 24;
      int var13 = -1;
      ...
      while(true) {
         ...
         while(true) {
                  ...
                  while(true) {
                     ...
                     while(true) {
                        ...
                        default:
                           ...
                           var4 = "Ù¥'øPX1\u0013W¾õXå\u000eMx";
                           var5 = "Ù¥'øPX1\u0013W¾õXå\u000eMx".length();
                           var2 = 0;
                        }
            ...
            default:
               ...
               var15 = "§j\u0000î5\u0010ì$\u0001è\u008f*_\u0016¨\\\u0018@(î\u009cÉ+4ß\u009b \u001ar½ï¬\u0094IéÙÆ\u0005#mÍ";
               var17 = "§j\u0000î5\u0010ì$\u0001è\u008f*_\u0016¨\\\u0018@(î\u009cÉ+4ß\u009b \u001ar½ï¬\u0094IéÙÆ\u0005#mÍ".length();
               var14 = 16;
               var13 = -1;
            }
   ...
   private static String b(int var0, long var1) {
      int var5 = var0 ^ (int)(var1 & 32767L) ^ 23079;
      if (e[var5] == null) {
         Object[] var4;
         try {
            ...
            throw new RuntimeException("su/catlean/nw", var10);
         }
   ...
   private static CallSite b(Lookup var0, String var1, MethodType var2) {
      ...
      try {
         ...
         throw new RuntimeException("su/catlean/nw" + " : " + var1 + " : " + var2.toString(), var5);
      }
   }

   private static int d(int var0, long var1) {
      int var3 = var0 ^ (int)(var1 & 32767L) ^ 6980;
      if (m[var3] == null) {
         ...
         try {
            ...
            throw new RuntimeException("su/catlean/nw", var14);
         }
