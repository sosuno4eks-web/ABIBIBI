...
public final class xn {
   ...
   @NotNull
   private static final class_11280 k;
   private static k9[] M;
   ...
   @NotNull
   public final class_11280 b() {
      return k;
   }

   static {
      long var11 = j0.a(440034159063819744L, 6082535292578966108L, MethodHandles.lookup().lookupClass()).a(140539203525038L) ^ 116780063947970L;
      if (4935539857285458500L.A<invokedynamic>(4935539857285458500L, var11) == null) {
         (new k9[2]).A<invokedynamic>(new k9[2], 4958600250098793550L, var11);
      }
      ...
      byte[] var10 = var8.doFinal("\u007f~:%WÄ2\u0000Ëx\u0092h2Vå=\u008c\u008b j\u008fºNÛ".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -7928814613732857056L;
      ...
      long var0 = var14;
      e = new xn();
      O = (new Std140SizeCalculator()).putVec4().putFloat().putVec4().putVec4().putFloat().get();
      k = new class_11280(var7, O, (int)var0);
   }

   public static void V(k9[] var0) {
      M = var0;
   }
