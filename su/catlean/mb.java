...
public final class mb {
   ...
   @NotNull
   private static final class_11280 C;
   ...
   static {
      long var11 = j0.a(1371340859258319182L, 1114337879556613473L, MethodHandles.lookup().lookupClass()).a(218387288205069L) ^ 28274290479602L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("VÎt\u0088X\u0010ñ\u0099\u001d\u0002cé^ÿF²Ú5 pð£4Ó".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -8406219663215326467L;
      ...
      long var0 = var14;
      S = new mb();
      w = (new Std140SizeCalculator()).putVec2().putVec2().putFloat().putFloat().putMat4f().putVec4().get();
      mb var15 = S;
      C = new class_11280(var7, w, (int)var0);
   }
