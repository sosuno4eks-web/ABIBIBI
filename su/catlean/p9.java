...
public final class p9 {
   ...
   @NotNull
   private static final class_11280 f;
   ...
   @NotNull
   public final class_11280 O() {
      return f;
   }

   static {
      long var11 = j0.a(8490530760838195847L, 4131751841462669247L, MethodHandles.lookup().lookupClass()).a(240139193858774L) ^ 132989665167786L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("lu[5[\u0005ÜU-ß¸\u008b®fí¶¡\u00ad\u0083¼X\u0013ãðÙsqÉH@$Ö".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -4939287132197002556L;
      ...
      long var0 = var14;
      P = new p9();
      s = (new Std140SizeCalculator()).putVec2().putFloat().putInt().get();
      p9 var15 = P;
      f = new class_11280(var7, s, (int)var0);
   }
