...
public final class ma {
   @NotNull
   public static final ma o;
   private static final int I;
   @NotNull
   private static final class_11280 Q;

   private ma() {
   }

   @NotNull
   public final class_11280 m() {
      return Q;
   }
   ...
   static {
      long var11 = j0.a(7475890425156039781L, 791018994696994059L, MethodHandles.lookup().lookupClass()).a(200744122100251L) ^ 50275004537606L;
      Cipher var8;
      ...
      byte[] var10 = var8.doFinal("Ã!;Ô\u009aÄ\u0085µ\u009f\u009b\u0084\u007f\u009f\u0087\u0003»%\bv\u009f:Ø\u0085û".getBytes("ISO-8859-1"));
      ...
      var10000.init(2, var10002.generateSecret(new DESKeySpec(var10003)), new IvParameterSpec(new byte[8]));
      long var4 = -2872391528242128667L;
      ...
      long var0 = var14;
      o = new ma();
      I = (new Std140SizeCalculator()).putVec2().putFloat().putFloat().putVec4().putFloat().putVec4().putFloat().get();
      Q = new class_11280(var7, I, (int)var0);
   }
